...
*/
  ...
  assign t_off_led_w    = t_off_led         * 16'd2; // Bug fix: t_off_led_w was declared but never assigned
  ...
  assign LED_ON_l     = IPD_SW_l + t_off_led_w; // Bug fix: was t_off_led (raw µs units, missing ×2 conversion)
