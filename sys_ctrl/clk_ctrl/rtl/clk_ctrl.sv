...
input  wire         ana_ppgclk_inv,   // ana ppg clock setting 
input  wire         ppg_clk50duty,            

output  wire 	    ppg_clk_running,
output  wire        clk_ppg,           //dig ppg clock  
output  wire        clk_sys_ppg,           //sys ppg clock 
output  wire        ana_clk_ppg,           //ana ppg clk
//==================
//for bps function
//==================
