...
// Generated on: 2025-10-20 19:01:43
// -------------------------------------------------------------
//========================================================================================  
// ----------------------------------------------------------------------------- 
...
//
// TargetDirectory: /home/zcao/cz/matlab/lpf/dengbowen
...
////////////////////////////////////////////////////////////////
  ...
  // Type Definitions
  // Constants
  parameter signed [17:0] coeff1 = 18'b000000000001000001; //sfix18_En18
  parameter signed [17:0] coeff2 = 18'b111111111110001000; //sfix18_En18
  parameter signed [17:0] coeff3 = 18'b111111110000100010; //sfix18_En18
  parameter signed [17:0] coeff4 = 18'b111111011111111110; //sfix18_En18
  parameter signed [17:0] coeff5 = 18'b111111101011100011; //sfix18_En18
  parameter signed [17:0] coeff6 = 18'b000000100110010000; //sfix18_En18
  parameter signed [17:0] coeff7 = 18'b000001011110110100; //sfix18_En18
  parameter signed [17:0] coeff8 = 18'b000000110000001010; //sfix18_En18
  parameter signed [17:0] coeff9 = 18'b111110000011001111; //sfix18_En18
  parameter signed [17:0] coeff10 = 18'b111100000000110111; //sfix18_En18
  parameter signed [17:0] coeff11 = 18'b111110110011011010; //sfix18_En18
  parameter signed [17:0] coeff12 = 18'b000111101001101000; //sfix18_En18
  parameter signed [17:0] coeff13 = 18'b010010000011101110; //sfix18_En18
  parameter signed [17:0] coeff14 = 18'b010110101110000011; //sfix18_En18
  parameter signed [17:0] coeff15 = 18'b010010000011101110; //sfix18_En18
  parameter signed [17:0] coeff16 = 18'b000111101001101000; //sfix18_En18
  parameter signed [17:0] coeff17 = 18'b111110110011011010; //sfix18_En18
  parameter signed [17:0] coeff18 = 18'b111100000000110111; //sfix18_En18
  parameter signed [17:0] coeff19 = 18'b111110000011001111; //sfix18_En18
  parameter signed [17:0] coeff20 = 18'b000000110000001010; //sfix18_En18
  parameter signed [17:0] coeff21 = 18'b000001011110110100; //sfix18_En18
  parameter signed [17:0] coeff22 = 18'b000000100110010000; //sfix18_En18
  parameter signed [17:0] coeff23 = 18'b111111101011100011; //sfix18_En18
  parameter signed [17:0] coeff24 = 18'b111111011111111110; //sfix18_En18
  parameter signed [17:0] coeff25 = 18'b111111110000100010; //sfix18_En18
  parameter signed [17:0] coeff26 = 18'b111111111110001000; //sfix18_En18
  parameter signed [17:0] coeff27 = 18'b000000000001000001; //sfix18_En18

  // Signals
  reg  [4:0] cur_count; // ufix5
  wire phase_26; // boolean
  wire phase_0; // boolean
  reg  signed [32:0] delay_pipeline [0:26] ; // sfix33
  ...
  reg cur_count_en;
  reg phase_26_dly1,phase_26_dly2;
...
always @ (posedge clk or negedge reset)begin
    if (reset == 1'b0) begin
        ...
        phase_26_dly1 <= phase_26;   
        phase_26_dly2 <= phase_26_dly1;
    end    
end 
...
always @ (posedge clk or negedge reset)begin
    ...
    else if (cur_count == 5'b11010) begin        
        cur_count_en <= 1'b0;        
    end
...
always @ (posedge clk or negedge reset) begin: Counter_process
    ...
    else if (cur_count_en) begin        
          if (cur_count == 5'b11010) begin
            cur_count <= 5'b00000;
          end
          else begin
  ...
  assign  phase_26 = (cur_count == 5'b11010) ? 1'b1 : 1'b0;
 ...
 assign filter_out  = ~sign_en? output_register_temp[31:0] + 32'h8000_0000 : output_register_temp[31:0];
