...
`ifdef BEHAVIORAL
assign   spi_vif.REG_BACKDOOR[2][8'h00+8'h40*i]        =   `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_config[7:0]             ;
assign   spi_vif.REG_BACKDOOR[2][8'h01+8'h40*i]        =   `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_ctrl[7:0]               ;
assign   spi_vif.REG_BACKDOOR[2][8'h02+8'h40*i]        =     `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_point_config[7:0];
assign   spi_vif.REG_BACKDOOR[2][8'h03+8'h40*i]        =   `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_in_wave_addr[7:0] ;
assign   spi_vif.REG_BACKDOOR[2][8'h04+8'h40*i]        =   `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_in_wave[`SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_in_wave_addr];
assign   spi_vif.REG_BACKDOOR[2][8'h05+8'h40*i]        =   `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_rest_t[7:0]             ;
assign   spi_vif.REG_BACKDOOR[2][8'h06+8'h40*i]        =   `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_rest_t[15:8]            ;
assign   spi_vif.REG_BACKDOOR[2][8'h07+8'h40*i]        =   `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_silent_t[7:0]           ;
assign   spi_vif.REG_BACKDOOR[2][8'h08+8'h40*i]        =   `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_silent_t[15:8]          ;
assign   spi_vif.REG_BACKDOOR[2][8'h09+8'h40*i]        =   `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_silent_t[23:16]         ;
assign   spi_vif.REG_BACKDOOR[2][8'h0a+8'h40*i]        =   `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_silent_t[31:24];
assign   spi_vif.REG_BACKDOOR[2][8'h0b+8'h40*i]        =   `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_hlf_wave_prd[7:0]       ;
assign   spi_vif.REG_BACKDOOR[2][8'h0c+8'h40*i]        =   `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_hlf_wave_prd[15:8]      ;
assign   spi_vif.REG_BACKDOOR[2][8'h0d+8'h40*i]        =   `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_neg_hlf_wave_prd[7:0]   ;
assign   spi_vif.REG_BACKDOOR[2][8'h0e+8'h40*i]        =   `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_neg_hlf_wave_prd[15:8]  ;
assign   spi_vif.REG_BACKDOOR[2][8'h0f+8'h40*i]        =     `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_rest_t1[7:0];
assign   spi_vif.REG_BACKDOOR[2][8'h10+8'h40*i]        =     `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_rest_t1[15:8];
assign   spi_vif.REG_BACKDOOR[2][8'h11+8'h40*i]        =     `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_silent_t1[7:0];
assign   spi_vif.REG_BACKDOOR[2][8'h12+8'h40*i]        =     `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_silent_t1[15:8];
assign   spi_vif.REG_BACKDOOR[2][8'h13+8'h40*i]        =     `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_silent_t1[23:16];
assign   spi_vif.REG_BACKDOOR[2][8'h14+8'h40*i]        =     `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_silent_t1[31:24];
assign   spi_vif.REG_BACKDOOR[2][8'h15+8'h40*i]        =     `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_hlf_wave_prd1[7:0];   
assign   spi_vif.REG_BACKDOOR[2][8'h16+8'h40*i]        =     `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_hlf_wave_prd1[15:8];
assign   spi_vif.REG_BACKDOOR[2][8'h17+8'h40*i]        =     `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_neg_hlf_wave_prd1[7:0];
assign   spi_vif.REG_BACKDOOR[2][8'h18+8'h40*i]        =     `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_neg_hlf_wave_prd1[15:8];
assign   spi_vif.REG_BACKDOOR[2][8'h19+8'h40*i]        =     `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_rest_t2[7:0];
assign   spi_vif.REG_BACKDOOR[2][8'h1a+8'h40*i]        =     `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_rest_t2[15:8];
assign   spi_vif.REG_BACKDOOR[2][8'h1b+8'h40*i]        =     `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_silent_t2[7:0];
assign   spi_vif.REG_BACKDOOR[2][8'h1c+8'h40*i]        =     `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_silent_t2[15:8];
assign   spi_vif.REG_BACKDOOR[2][8'h1d+8'h40*i]        =     `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_silent_t2[23:16];
assign   spi_vif.REG_BACKDOOR[2][8'h1e+8'h40*i]        =     `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_silent_t2[31:24];
assign   spi_vif.REG_BACKDOOR[2][8'h1f+8'h40*i]        =     `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_hlf_wave_prd2[7:0];
assign   spi_vif.REG_BACKDOOR[2][8'h20+8'h40*i]        =     `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_hlf_wave_prd2[15:8];
assign   spi_vif.REG_BACKDOOR[2][8'h21+8'h40*i]        =     `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_neg_hlf_wave_prd2[7:0];
assign   spi_vif.REG_BACKDOOR[2][8'h22+8'h40*i]        =     `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_neg_hlf_wave_prd2[15:8];
assign   spi_vif.REG_BACKDOOR[2][8'h23+8'h40*i]        =   `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_delay_lim[7:0]         ;
assign   spi_vif.REG_BACKDOOR[2][8'h24+8'h40*i]        =   `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_delay_lim[15:8]        ;
assign   spi_vif.REG_BACKDOOR[2][8'h25+8'h40*i]        =   `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_neg_scale[7:0]         ;
assign   spi_vif.REG_BACKDOOR[2][8'h26+8'h40*i]        =   `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_neg_offset[7:0]        ;
assign   spi_vif.REG_BACKDOOR[2][8'h27+8'h40*i]        =   {`SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.wg_driver_pos_scale, `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_isel[7:0]} ;
assign   spi_vif.REG_BACKDOOR[2][8'h28+8'h40*i]        =   `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_pos_offset[7:0]       ;
assign   spi_vif.REG_BACKDOOR[2][8'h29+8'h40*i]        =     `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_pullba         ;
assign   spi_vif.REG_BACKDOOR[2][8'h2A+8'h40*i]        =   `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.o_wg_driver_int_cnt[7:0];
assign   spi_vif.REG_BACKDOOR[2][8'h2b+8'h40*i]        =   {2'b00,`SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.i_wg_driver_int_sts[1:0], `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.o_wg_driver_int_en, `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.NO_OF_WAVEGEN[2:0]};
assign   spi_vif.REG_BACKDOOR[2][8'h2c+8'h40*i]        =   `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_int[15:8]              ;
assign   spi_vif.REG_BACKDOOR[2][8'h2d+8'h40*i]        =   `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_int[23:16]             ;
assign   spi_vif.REG_BACKDOOR[2][8'h2e+8'h40*i]        =   `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_alt_lim[7:0]           ;
assign   spi_vif.REG_BACKDOOR[2][8'h2f+8'h40*i]        =   `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_alt_lim[15:8]          ;
assign   spi_vif.REG_BACKDOOR[2][8'h30+8'h40*i]        =   `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_alt_silent_lim[7:0]    ;
assign   spi_vif.REG_BACKDOOR[2][8'h31+8'h40*i]        =   `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.reg_wg_driver_alt_silent_lim[15:8]   ;
assign   spi_vif.REG_BACKDOOR[2][8'h32+8'h40*i]        =     `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.drive_ctrl_reg0       ;
assign   spi_vif.REG_BACKDOOR[2][8'h33+8'h40*i]        =     `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.drive_ctrl_reg1       ;
assign   spi_vif.REG_BACKDOOR[2][8'h34+8'h40*i]        =     `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.drive_ctrl_reg2       ;
assign   spi_vif.REG_BACKDOOR[2][8'h35+8'h40*i]        =     {7'b0,`SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.o_no_of_num_slient_disable};
assign   spi_vif.REG_BACKDOOR[2][8'h36+8'h40*i]        =     `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.o_no_of_num_slient_tar[7:0];
assign   spi_vif.REG_BACKDOOR[2][8'h37+8'h40*i]        =     `SPI_TOP.spi_reg_u.genblk1[i].u_spi_reg_wavegen.o_no_of_num_slient_tar[15:8];
`endif
end                                                                                                                                               
endgenerate  
*/  
