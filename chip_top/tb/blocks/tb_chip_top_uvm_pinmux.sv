...
nnc_pinmux_interface     pinmux_vif();
    ...
    assign pinmux_vif.intb = `DIG_TOP.u_pinmux.GPIO8_NORMAL_OUT;
    //assign pinmux_vif.gpio14_normal_out_sel = `DIG_TOP.u_pinmux.GPIO14_NORMAL_OUT;
    ...
    assign pinmux_vif.clk = `CLK_CTRL_TOP.pclk;
    //SCAN MODE
