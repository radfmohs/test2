# ------------------------------------------------------------------------------
# Purpose : PrimeTime Script - Extract SLOW corner .lib for filter_wrapper
# ------------------------------------------------------------------------------
...
read_verilog ../data/synthesis_l3/filter_wrapper.scan.v
...
source ../data/synthesis_l3/filter_wrapper.DC.sdc
# ------------------------------------------------------------------------------
# PrimeTime settings
# ------------------------------------------------------------------------------
...
report_timing -max_paths 10 > ../report/synthesis_l3/filter_wrapper.pt_timing_${corner}.rpt
report_constraint -all_violators > ../report/synthesis_l3/filter_wrapper.pt_violations_${corner}.rpt
report_clock > ../report/synthesis_l3/filter_wrapper.pt_clocks_${corner}.rpt

# ------------------------------------------------------------------------------
# Extract SLOW corner .lib
# ------------------------------------------------------------------------------
...
extract_model -output ../data/synthesis_l3/filter_wrapper_${corner} -format lib
