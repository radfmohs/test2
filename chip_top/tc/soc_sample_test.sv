...
//--------------------------------------------------------------------------------------
// File Name	: soc_sample_test.sv                                                   
// Project	: Nanochap ENS2                                  		        
// Description	: Testcase soc_sample_test                                             
// Designer	: CREATOR@nanochap.com                                                                 
// Date		: CREATEDTIME                                                                     
...
// -------------------------------------------------
`define TESTNAME soc_sample_test
`define TESTCFG soc_sample_test_cfg
...
class `TESTCFG extends soc_base_test_cfg;
  ...
  function new (string name = "soc_sample_test_cfg");
    super.new(name);
...
class `TESTNAME extends soc_base_test;
  ...
  virtual task main_phase(nnc_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_sample_test start", NNC_LOW)
    ...
    // --------------------------------------------------------
    #10000ns;
    `nnc_info("SOC_TEST", "soc_sample_test end now", NNC_LOW)
