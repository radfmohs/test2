...
//--------------------------------------------------------------------------------------
// File Name	: soc_mult_chip_wavegen_drva_sine_test.sv                                                   
// Project	: Nanochap ENS2                                  		        
// Description	: Testcase soc_mult_chip_wavegen_drva_sine_test                                             
...
//        The test is intented to generate sine wave for driver1 & driver2 in multiple devices.
...
`define TESTNAME soc_mult_chip_wavegen_drva_sine_test
`define TESTCFG soc_mult_chip_wavegen_drva_sine_test_cfg
...
class `TESTCFG extends `TESTCFG_BASE;
  ...
  function new (string name = "soc_mult_chip_wavegen_drva_sine_test_cfg");
    super.new(name);
