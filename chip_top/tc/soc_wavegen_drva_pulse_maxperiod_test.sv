...
//--------------------------------------------------------------------------------------
// File Name	: soc_wavegen_drva_pulse_maxperiod_test.sv                                                   
// Project	: Nanochap ENS2                                  		        
// Description	: Testcase soc_wavegen_drva_pulse_maxperiod_test                                             
...
//***************************************************************************************
// NOTE : This test uses maximum period settings to generate pulse waveform
//***************************************************************************************

// =================================================
// Testcase name is defined
// -------------------------------------------------
`define TESTNAME soc_wavegen_drva_pulse_maxperiod_test
`define TESTCFG soc_wavegen_drva_pulse_maxperiod_test_cfg
...
class `TESTCFG extends soc_wavegen_base_test_cfg;
  ...
  function new (string name = "soc_wavegen_drva_pulse_maxperiod_test_cfg");
    super.new(name);
  ...
  constraint c_points_sel      { (load_points_sel == 1'b0) -> points_sel != 6;
                                 ...
                                 ((waveform_sel == 3'b000) && (neg_ena == 1'b1) && (pos_dis == 1'b0) && (pos_neg_diff_sel == 1'b1)) -> points_sel inside {[7:7]};//128 points
...
class `TESTNAME extends soc_wavegen_base_test;
  ...
  virtual task main_phase(nnc_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_wavegen_drva_pulse_maxperiod_test start", NNC_LOW)
    ...
    `DUT_IF.wg_hlf_wave0_lim[i] = 16'hffff;//top_test_cfg.hlf_wave_lim / top_test_cfg.NO_OF_POINTS;
    `DUT_IF.wg_neg_hlf_wave0_lim[i] = 16'hffff;//top_test_cfg.neg_hlf_wave_lim / top_test_cfg.NO_OF_POINTS;
    `DUT_IF.wg_rest_wave0_lim[i] = 16'hffff;//top_test_cfg.rest_lim;
    `DUT_IF.wg_silent_wave0_lim[i] = 32'hffffffff;//top_test_cfg.silent_lim;
    ...
    `DUT_IF.wg_hlf_wave1_lim[i] = 16'hffff;//top_test_cfg.hlf_wave_lim / top_test_cfg.NO_OF_POINTS;
    `DUT_IF.wg_neg_hlf_wave1_lim[i] = 16'hffff;//top_test_cfg.neg_hlf_wave_lim / top_test_cfg.NO_OF_POINTS;
    `DUT_IF.wg_rest_wave1_lim[i] = 16'hffff;//top_test_cfg.rest_lim;
    `DUT_IF.wg_silent_wave1_lim[i] = 32'hffffffff;//top_test_cfg.silent_lim;
    ...
    `DUT_IF.wg_hlf_wave2_lim[i] = 16'hffff;//top_test_cfg.hlf_wave_lim / top_test_cfg.NO_OF_POINTS;
    `DUT_IF.wg_neg_hlf_wave2_lim[i] = 16'hffff;//top_test_cfg.neg_hlf_wave_lim / top_test_cfg.NO_OF_POINTS;
    `DUT_IF.wg_rest_wave2_lim[i] = 16'hffff;//top_test_cfg.rest_lim;
    `DUT_IF.wg_silent_wave2_lim[i] = 32'hffffffff;//top_test_cfg.silent_lim;
    ...
    // --------------------------------------------------------
    #17s;
    `nnc_info("SOC_TEST", "soc_wavegen_drva_pulse_maxperiod_test end now", NNC_LOW)
