...
//--------------------------------------------------------------------------------------
// File Name	: soc_wavegen_pair_drv_triangle_test.sv                                                   
// Project	: Nanochap ENS2                                  		        
// Description	: Testcase soc_wavegen_pair_drv_triangle_test                                             
...
// -------------------------------------------------
`define TESTNAME soc_wavegen_pair_drv_triangle_test
`define TESTCFG soc_wavegen_pair_drv_triangle_test_cfg
...
class `TESTCFG extends soc_wavegen_pair_drv_base_test_cfg;
  ...
  function new (string name = "soc_wavegen_pair_drv_triangle_test_cfg");
    super.new(name);
...
class `TESTNAME extends soc_wavegen_pair_drv_base_test;
  ...
  virtual task main_phase(nnc_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_wavegen_pair_drv_triangle_test start", NNC_LOW)
    ...
    // --------------------------------------------------------
    #10000ns;
    `nnc_info("SOC_TEST", "soc_wavegen_pair_drv_triangle_test end now", NNC_LOW)
