...
`else
        if (`ANA_WRAPPER_TOP.pinmux_if_D2A_ADJ_IO[79:72]!== 8'h0) begin
        `nnc_error("ATM24", $sformatf("`SOC_TOP.pinmux_if_D2A_ADJ_IO[79:72] = %b is not as expectation of = %b", `ANA_WRAPPER_TOP.pinmux_if_D2A_ADJ_IO[79:72], 8'h0));
        end
`endif
