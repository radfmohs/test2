...
//--------------------------------------------------------------------------------------
// File Name	: soc_wavegen_pair_drv_dc_test.sv                                                   
// Project	: Nanochap ENS2                                  		        
// Description	: Testcase soc_wavegen_pair_drv_dc_test                                             
...
// -------------------------------------------------
`define TESTNAME soc_wavegen_pair_drv_dc_test
`define TESTCFG soc_wavegen_pair_drv_dc_test_cfg
...
class `TESTCFG extends soc_wavegen_pair_drv_base_test_cfg;
  ...
  function new (string name = "soc_wavegen_pair_drv_dc_test_cfg");
    super.new(name);
  ...
  constraint c_preload_sel     { wg_sine_en == 1'b1 -> preload_sel inside {0,3}; 
                                 ...
                                 wg_dc_en == 1'b1 -> preload_sel inside {1,1};
  ...
  constraint c_wg_dc_en        { wg_dc_en == 1'b1; }
...
class `TESTNAME extends soc_wavegen_pair_drv_base_test;
  ...
  virtual task main_phase(nnc_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_wavegen_pair_drv_dc_test start", NNC_LOW)
    ...
    // --------------------------------------------------------
    #10000ns;
    `nnc_info("SOC_TEST", "soc_wavegen_pair_drv_dc_test end now", NNC_LOW)
