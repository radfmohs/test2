...
//--------------------------------------------------------------------------------------
// File Name	: soc_anac_leadoffbyshort_DC_test.sv                                                   
// Project	: Nanochap ENS2                                  		        
// Description	: Testcase soc_anac_leadoffbyshort_DC_test                                             
...
//        This test performs leadoff detection using short circuit block for positive or 
//        negative DC waveforms, using lead_off_detect_by_short_circuit_en feature.
...
`define TESTNAME soc_anac_leadoffbyshort_DC_test
`define TESTCFG soc_anac_leadoffbyshort_DC_test_cfg
...
class `TESTCFG extends `TESTCFG_BASE;
  ...
  function new (string name = "soc_anac_leadoffbyshort_DC_test_cfg");
    super.new(name);
...
class `TESTNAME extends `TESTNAME_BASE;
  ...
  virtual task main_phase(nnc_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_anac_leadoffbyshort_DC_test start", NNC_LOW)
