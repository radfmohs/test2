...
`endif  
    ...
    if (top_test_cfg.atm !== (29'b1_0000_0000_0000_0000_0000_0000_0000 >> `SOC_TOP.IOBUF_PAD[14:10]))
      begin
        `nnc_error("ATM18", $sformatf("ATM[0:28] = %b is not as expectation of ATM = %b", top_test_cfg.atm, (29'b1_0000_0000_0000_0000_0000_0000_0000 >> `SOC_TOP.IOBUF_PAD[14:10])))
      end  
    ...
    if (`ANA_TOP.D2A_OSC8MHZEN !== 1'b0)
      begin
        `nnc_error("ATM18", $sformatf("D2A_OSC8MHZEN = %b is not as expectation of 1'b0", `ANA_TOP.D2A_OSC8MHZEN))
      end 
