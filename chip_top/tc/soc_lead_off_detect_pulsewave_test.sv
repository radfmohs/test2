...
//--------------------------------------------------------------------------------------
// File Name	: soc_lead_off_detect_pulsewave_test.sv                                                   
// Project	: Nanochap ENS2                                  		        
// Description	: Testcase soc_lead_off_detect_pulsewave_test                                             
...
// -------------------------------------------------
`define TESTNAME soc_lead_off_detect_pulsewave_test
`define TESTCFG soc_lead_off_detect_pulsewave_test_cfg
...
class `TESTCFG extends soc_lead_off_detect_base_test_cfg;
  ...
  function new (string name = "soc_lead_off_detect_pulsewave_test_cfg");
    super.new(name);
  endfunction: new
...
class `TESTNAME extends soc_lead_off_detect_base_test;
  ...
  virtual task main_phase(nnc_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_lead_off_detect_pulsewave_test start", NNC_LOW)
    super.main_phase(phase);
    `nnc_info("SOC_TEST", "soc_lead_off_detect_pulsewave_test end now", NNC_LOW)
