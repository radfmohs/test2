...
//--------------------------------------------------------------------------------------
// File Name	: soc_anac_leadoffbyshort_pulse_wave_test.sv                                                   
// Project	: Nanochap ENS2                                  		        
// Description	: Testcase soc_anac_leadoffbyshort_pulse_wave_test                                             
...
//*******************************************************************************************
// NOTE : This test is extended from soc_anac_short_pulsewave_test.
//        This test is used to check leadoff detection using short circuit block for 
//        pulse waveforms, using lead_off_detect_by_short_circuit_en feature.
...
// -------------------------------------------------
`define TESTNAME_BASE soc_anac_short_pulsewave_test
`define TESTCFG_BASE soc_anac_short_pulsewave_test_cfg
`define TESTNAME soc_anac_leadoffbyshort_pulse_wave_test
`define TESTCFG soc_anac_leadoffbyshort_pulse_wave_test_cfg
...
class `TESTCFG extends `TESTCFG_BASE;
  ...
  function new (string name = "soc_anac_leadoffbyshort_pulse_wave_test_cfg");
    super.new(name);
...
class `TESTNAME extends `TESTNAME_BASE;
  ...
  virtual task main_phase(nnc_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_anac_leadoffbyshort_pulse_wave_test start", NNC_LOW)
