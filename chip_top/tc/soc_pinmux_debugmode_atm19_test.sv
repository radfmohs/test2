...
`else
        if (`ANA_WRAPPER_TOP.pinmux_if_D2A_ADJ_IO[39:32]!== {rand_num[7:0]}) begin
        `nnc_error("ATM19", $sformatf("`SOC_TOP.pinmux_if_D2A_ADJ_IO[39:32] = %b is not as expectation of = %b", `ANA_WRAPPER_TOP.pinmux_if_D2A_ADJ_IO[39:32], {rand_num[7:0]}));
        end
`endif
