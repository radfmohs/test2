...
//--------------------------------------------------------------------------------------
// File Name	: soc_app_demo_scenario_sine_pulse_triangle_mixedwave_test.sv                                                   
// Project	: Nanochap ENS2                                  		        
// Description	: Testcase soc_app_demo_scenario_sine_pulse_triangle_mixedwave_test                                             
...
//************************************************************************************
// NOTE : This test checks the leadoff and after that short for sine-pulse-triangle wave 
//************************************************************************************

// =================================================
// Testcase name is defined
// -------------------------------------------------
`define TESTNAME soc_app_demo_scenario_sine_pulse_triangle_mixedwave_test
`define TESTCFG soc_app_demo_scenario_sine_pulse_triangle_mixedwave_test_cfg
...
class `TESTCFG extends soc_app_demo_scenario_base_test_cfg;
  ...
  //preload_sel
  constraint c_preload_sel     { preload_sel inside {0,1};} // 0: sine-pulse-triangle preloaded, 1: sine-triangle-pulse preloaded

  //waveform_sel
  constraint c_waveform_sel    { waveform_sel == 2;} // waveform_sel should be 2 to get sine/triangle/pulse mixed wave
...
class `TESTNAME extends soc_app_demo_scenario_base_test;
  ...
  virtual task main_phase(nnc_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_app_demo_scenario_sine_pulse_triangle_mixedwave_test start", NNC_LOW)
    super.main_phase(phase);
    `nnc_info("SOC_TEST", "soc_app_demo_scenario_sine_pulse_triangle_mixedwave_test end now", NNC_LOW)
