...
//--------------------------------------------------------------------------------------
// File Name	: soc_mult_chip_wavegen_drva_arbitrary_nointerrupt_test.sv                                                   
// Project	: Nanochap ENS2                                  		        
// Description	: Testcase soc_mult_chip_wavegen_drva_arbitrary_nointerrupt_test                                             
...
//***********************************************************************************************
// NOTE : This test is extended from soc_wavegen_drva_arbitrary_nointerrupt_test. 
//        The test is intented to generate arbitrary wave for driver1 & driver2 in multiple devices.
...
// -------------------------------------------------
`define TESTNAME_BASE soc_wavegen_drva_arbitrary_nointerrupt_test
`define TESTCFG_BASE soc_wavegen_drva_arbitrary_nointerrupt_test_cfg
`define TESTNAME soc_mult_chip_wavegen_drva_arbitrary_nointerrupt_test
`define TESTCFG soc_mult_chip_wavegen_drva_arbitrary_nointerrupt_test_cfg
...
class `TESTCFG extends `TESTCFG_BASE;
  ...
  function new (string name = "soc_mult_chip_wavegen_drva_arbitrary_nointerrupt_test_cfg");
    super.new(name);
