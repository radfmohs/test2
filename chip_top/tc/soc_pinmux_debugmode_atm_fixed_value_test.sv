...
`ifndef FPGA
   ...
   `nnc_info("Checking ATM - Start", "Checking ATM20 Done", UVM_LOW);
    ...
    if(`ANA_TOP.D2A_NIRS4_IDAC_EN !== 1'b1)`nnc_error("ATM20",$sformatf("D2A_NIRS4_IDAC_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_NIRS4_IDAC_EN));
   ...
   `nnc_info("Disable internal POR and clock", "Disable internal POR and clock", UVM_LOW);
    ...
    if(`ANA_TOP.D2A_BIST_SEL !== 5'b00000)`nnc_error("ATM0",$sformatf("D2A_BIST_SEL error, Real data:%b not match 5'b00000",`ANA_TOP.D2A_BIST_SEL)); 
    if(`ANA_TOP.D2A_BIST_EN !== 1'b1)`nnc_error("ATM0",$sformatf("D2A_BIST_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_BIST_EN)); 
    if(`ANA_TOP.D2A_OSC8MHZEN !== 1'b0)`nnc_error("ATM0",$sformatf("D2A_OSC8MHZEN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_OSC8MHZEN)); 
    if(`ANA_TOP.D2A_BGBUFFER_CPTEST_EN !== 1'b0)`nnc_error("ATM0",$sformatf("D2A_BGBUFFER_CPTEST_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_BGBUFFER_CPTEST_EN));
   `nnc_info("Checking ATM - Done", "Checking ATM 0 Done", UVM_LOW);
    ...
    if(`ANA_TOP.D2A_BIST_SEL !== 5'b00001)`nnc_error("ATM1",$sformatf("D2A_BIST_SEL error, Real data:%b not match 5'b00001",`ANA_TOP.D2A_BIST_SEL)); 
    if(`ANA_TOP.D2A_BIST_EN !== 1'b1)`nnc_error("ATM1",$sformatf("D2A_BIST_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_BIST_EN)); 
    if(`ANA_TOP.D2A_OSC8MHZEN !== 1'b0)`nnc_error("ATM1",$sformatf("D2A_OSC8MHZEN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_OSC8MHZEN)); 
    if(`ANA_TOP.D2A_BGBUFFER_CPTEST_EN !== 1'b0)`nnc_error("ATM1",$sformatf("D2A_BGBUFFER_CPTEST_EN, Real data:%b not match 1'b0",`ANA_TOP.D2A_BGBUFFER_CPTEST_EN));
   `nnc_info("Checking ATM - Done", "Checking ATM1 Done", UVM_LOW);
   ...
   `nnc_info("Checking ATM - Start", "Checking ATM2 Done", UVM_LOW);
    ...
    if(`ANA_TOP.D2A_BIST_SEL !== 5'b00010)`nnc_error("ATM2",$sformatf("D2A_BIST_SEL error, Real data:%b not match 5'b00010",`ANA_TOP.D2A_BIST_SEL)); 
    if(`ANA_TOP.D2A_BIST_EN !== 1'b1)`nnc_error("ATM2",$sformatf("D2A_BIST_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_BIST_EN)); 
    if(`ANA_TOP.D2A_OSC8MHZEN !== 1'b0)`nnc_error("ATM2",$sformatf("D2A_OSC8MHZEN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_OSC8MHZEN)); 
    if(`ANA_TOP.D2A_BGBUFFER_CPTEST_EN !== 1'b0)`nnc_error("ATM2",$sformatf("D2A_BGBUFFER_CPTEST_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_BGBUFFER_CPTEST_EN));
   `nnc_info("Checking ATM - Done", "Checking ATM2 Done", UVM_LOW);
   ...
   `nnc_info("Checking ATM - Start", "Checking ATM3 Done", UVM_LOW);
    ...
    if(`ANA_TOP.D2A_BIST_SEL !== 5'b00011)`nnc_error("ATM3",$sformatf("D2A_BIST_SEL error, Real data:%b not match 5'b00011",`ANA_TOP.D2A_BIST_SEL)); 
    if(`ANA_TOP.D2A_BIST_EN !== 1'b1)`nnc_error("ATM3",$sformatf("D2A_BIST_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_BIST_EN)); 
    if(`ANA_TOP.D2A_OSC8MHZEN !== 1'b0)`nnc_error("ATM3",$sformatf("D2A_OSC8MHZEN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_OSC8MHZEN)); 
    if(`ANA_TOP.D2A_BGBUFFER_CPTEST_EN !== 1'b0)`nnc_error("ATM3",$sformatf("D2A_BGBUFFER_CPTEST_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_BGBUFFER_CPTEST_EN));
   `nnc_info("Checking ATM - Done", "Checking ATM3 Done", UVM_LOW);
   ...
   `nnc_info("Checking ATM - Start", "Checking ATM4 Done", UVM_LOW);
    ...
    if(`ANA_TOP.D2A_BIST_SEL !== 5'b00100)`nnc_error("ATM4",$sformatf("D2A_BIST_SEL error, Real data:%b not match 5'b00100",`ANA_TOP.D2A_BIST_SEL)); 
    if(`ANA_TOP.D2A_BIST_EN !== 1'b1)`nnc_error("ATM4",$sformatf("D2A_BIST_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_BIST_EN)); 
    if(`ANA_TOP.D2A_OSC8MHZEN !== 1'b0)`nnc_error("ATM4",$sformatf("D2A_OSC8MHZEN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_OSC8MHZEN)); 
    if(`ANA_TOP.D2A_BGBUFFER_CPTEST_EN !== 1'b0)`nnc_error("ATM4",$sformatf("D2A_BGBUFFER_CPTEST_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_BGBUFFER_CPTEST_EN));
   `nnc_info("Checking ATM - Done", "Checking ATM4 Done", UVM_LOW);
   ...
   `nnc_info("Checking ATM - Start", "Checking ATM5 Done", UVM_LOW);
    ...
    if(`ANA_TOP.D2A_BIST_SEL !== 5'b00101)`nnc_error("ATM5",$sformatf("D2A_BIST_SEL error, Real data:%b not match 5'b00101",`ANA_TOP.D2A_BIST_SEL)); 
    if(`ANA_TOP.D2A_BIST_EN !== 1'b1)`nnc_error("ATM5",$sformatf("D2A_BIST_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_BIST_EN)); 
    if(`ANA_TOP.D2A_OSC8MHZEN !== 1'b0)`nnc_error("ATM5",$sformatf("D2A_OSC8MHZEN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_OSC8MHZEN)); 
    if(`ANA_TOP.D2A_BGBUFFER_CPTEST_EN !== 1'b0)`nnc_error("ATM5",$sformatf("D2A_BGBUFFER_CPTEST_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_BGBUFFER_CPTEST_EN));
    if(`ANA_TOP.D2A_EN_TSC !== 1'b0)`nnc_error("ATM5",$sformatf("D2A_EN_TSC error, Real data:%b not match 1'b0",`ANA_TOP.D2A_EN_TSC));
   `nnc_info("Checking ATM - Done", "Checking ATM5 Done", UVM_LOW);
   ...
   `nnc_info("Checking ATM - Start", "Checking ATM6 Done", UVM_LOW);
    ...
    if(`ANA_TOP.D2A_BIST_SEL !== 5'b00110)`nnc_error("ATM6",$sformatf("D2A_BIST_SEL error, Real data:%b not match 5'b00110",`ANA_TOP.D2A_BIST_SEL)); 
    if(`ANA_TOP.D2A_BIST_EN !== 1'b1)`nnc_error("ATM6",$sformatf("D2A_BIST_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_BIST_EN)); 
    if(`ANA_TOP.D2A_OSC8MHZEN !== 1'b0)`nnc_error("ATM6",$sformatf("D2A_OSC8MHZEN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_OSC8MHZEN)); 
    if(`ANA_TOP.D2A_BGBUFFER_CPTEST_EN !== 1'b0)`nnc_error("ATM6",$sformatf("D2A_BGBUFFER_CPTEST_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_BGBUFFER_CPTEST_EN));
    if(`ANA_TOP.D2A_DRIVER_CUR_EN !== 1'b1)`nnc_error("ATM6",$sformatf("D2A_DRIVER_CUR_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_DRIVER_CUR_EN)); 
    if(`ANA_TOP.D2A_STIMU_EN !== 1'b1)`nnc_error("ATM6",$sformatf("D2A_STIMU_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_STIMU_EN));
   `nnc_info("Checking ATM - Done", "Checking ATM6 Done", UVM_LOW);
   ...
   `nnc_info("Checking ATM - Start", "Checking ATM7 Done", UVM_LOW);
    ...
    if(`ANA_TOP.D2A_BIST_SEL !== 5'b00111)`nnc_error("ATM7",$sformatf("D2A_BIST_SEL error, Real data:%b not match 5'b00111",`ANA_TOP.D2A_BIST_SEL)); 
    if(`ANA_TOP.D2A_BIST_EN !== 1'b1)`nnc_error("ATM7",$sformatf("D2A_BIST_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_BIST_EN)); 
    if(`ANA_TOP.D2A_OSC8MHZEN !== 1'b0)`nnc_error("ATM7",$sformatf("D2A_OSC8MHZEN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_OSC8MHZEN)); 
    if(`ANA_TOP.D2A_BGBUFFER_CPTEST_EN !== 1'b0)`nnc_error("ATM7",$sformatf("D2A_BGBUFFER_CPTEST_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_BGBUFFER_CPTEST_EN));
   `nnc_info("Checking ATM - Done", "Checking ATM7 Done", UVM_LOW);
   ...
   `nnc_info("Checking ATM - Start", "Checking ATM8 Done", UVM_LOW);
    ...
    if(`ANA_TOP.D2A_BIST_SEL !== 5'b01000)`nnc_error("ATM8",$sformatf("D2A_BIST_SEL error, Real data:%b not match 5'b01000",`ANA_TOP.D2A_BIST_SEL)); 
    if(`ANA_TOP.D2A_BIST_EN !== 1'b1)`nnc_error("ATM8",$sformatf("D2A_BIST_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_BIST_EN)); 
    if(`ANA_TOP.D2A_OSC8MHZEN !== 1'b0)`nnc_error("ATM8",$sformatf("D2A_OSC8MHZEN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_OSC8MHZEN)); 
    if(`ANA_TOP.D2A_BGBUFFER_CPTEST_EN !== 1'b0)`nnc_error("ATM8",$sformatf("D2A_BGBUFFER_CPTEST_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_BGBUFFER_CPTEST_EN));
   `nnc_info("Checking ATM - Done", "Checking ATM8 Done", UVM_LOW);
   ...
   `nnc_info("Checking ATM - Start", "Checking ATM9 Done", UVM_LOW);
    ...
    if(`ANA_TOP.D2A_BIST_SEL !== 5'b01001)`nnc_error("ATM9",$sformatf("D2A_BIST_SEL error, Real data:%b not match 5'b01001",`ANA_TOP.D2A_BIST_SEL)); 
    if(`ANA_TOP.D2A_BIST_EN !== 1'b1)`nnc_error("ATM9",$sformatf("D2A_BIST_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_BIST_EN)); 
    if(`ANA_TOP.D2A_OSC8MHZEN !== 1'b0)`nnc_error("ATM9",$sformatf("D2A_OSC8MHZEN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_OSC8MHZEN)); 
    if(`ANA_TOP.D2A_BGBUFFER_CPTEST_EN !== 1'b0)`nnc_error("ATM9",$sformatf("D2A_BGBUFFER_CPTEST_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_BGBUFFER_CPTEST_EN));
   `nnc_info("Checking ATM - Done", "Checking ATM9 Done", UVM_LOW);
   ...
   `nnc_info("Checking ATM - Start", "Checking ATM10 Done", UVM_LOW);
    ...
    if(`ANA_TOP.D2A_BIST_SEL !== 5'b01010)`nnc_error("ATM10",$sformatf("D2A_BIST_SEL error, Real data:%b not match 5'b01010",`ANA_TOP.D2A_BIST_SEL)); 
    if(`ANA_TOP.D2A_BIST_EN !== 1'b1)`nnc_error("ATM10",$sformatf("D2A_BIST_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_BIST_EN)); 
    if(`ANA_TOP.D2A_OSC8MHZEN !== 1'b0)`nnc_error("ATM10",$sformatf("D2A_OSC8MHZEN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_OSC8MHZEN)); 
    if(`ANA_TOP.D2A_BGBUFFER_CPTEST_EN !== 1'b0)`nnc_error("ATM10",$sformatf("D2A_BGBUFFER_CPTEST_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_BGBUFFER_CPTEST_EN));
   `nnc_info("Checking ATM - Done", "Checking ATM10 Done", UVM_LOW);
   ...
   `nnc_info("Checking ATM - Start", "Checking ATM11 Done", UVM_LOW);
    ...
    if(`ANA_TOP.D2A_BIST_SEL !== 5'b01011)`nnc_error("ATM11",$sformatf("D2A_BIST_SEL error, Real data:%b not match 5'b01011",`ANA_TOP.D2A_BIST_SEL)); 
    if(`ANA_TOP.D2A_BIST_EN !== 1'b1)`nnc_error("ATM11",$sformatf("D2A_BIST_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_BIST_EN)); 
    if(`ANA_TOP.D2A_OSC8MHZEN !== 1'b0)`nnc_error("ATM11",$sformatf("D2A_OSC8MHZEN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_OSC8MHZEN)); 
    if(`ANA_TOP.D2A_BGBUFFER_CPTEST_EN !== 1'b0)`nnc_error("ATM11",$sformatf("D2A_BGBUFFER_CPTEST_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_BGBUFFER_CPTEST_EN));
   `nnc_info("Checking ATM - Done", "Checking ATM11 Done", UVM_LOW);
   ...
   `nnc_info("Checking ATM - Start", "Checking ATM12 Done", UVM_LOW);
    ...
    if(`ANA_TOP.D2A_BIST_SEL !== 5'b01100)`nnc_error("ATM12",$sformatf("D2A_BIST_SEL error, Real data:%b not match 5'b01100",`ANA_TOP.D2A_BIST_SEL)); 
    if(`ANA_TOP.D2A_BIST_EN !== 1'b1)`nnc_error("ATM12",$sformatf("D2A_BIST_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_BIST_EN)); 
    if(`ANA_TOP.D2A_OSC8MHZEN !== 1'b0)`nnc_error("ATM12",$sformatf("D2A_OSC8MHZEN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_OSC8MHZEN)); 
    if(`ANA_TOP.D2A_BGBUFFER_CPTEST_EN !== 1'b0)`nnc_error("ATM12",$sformatf("D2A_BGBUFFER_CPTEST_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_BGBUFFER_CPTEST_EN));
    if(`ANA_TOP.D2A_RLD_ELECTRODE_EN !== 1'b0)`nnc_error("ATM12",$sformatf("D2A_RLD_ELECTRODE_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_RLD_ELECTRODE_EN));
    if(`ANA_TOP.D2A_VCMGENBUFF_EN !== 1'b0)`nnc_error("ATM12",$sformatf("D2A_VCMGENBUFF_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_VCMGENBUFF_EN));
    if(`ANA_TOP.D2A_SDMVCMBUFF_EN !== 1'b0)`nnc_error("ATM12",$sformatf("D2A_SDMVCMBUFF_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_SDMVCMBUFF_EN));
    if(`ANA_TOP.D2A_SDMVREFPBUFF_EN !== 1'b0)`nnc_error("ATM12",$sformatf("D2A_SDMVREFPBUFF_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_SDMVREFPBUFF_EN));
    if(`ANA_TOP.D2A_EEGLNA_EN !== 16'h0100)`nnc_error("ATM12",$sformatf("D2A_EEGLNA_EN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_EEGLNA_EN));
    if(`ANA_TOP.D2A_EEGPGA_EN !== 16'h0100)`nnc_error("ATM12",$sformatf("D2A_EEGPGA_EN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_EEGPGA_EN));
    if(`ANA_TOP.D2A_SDMBUFF_EN !== 16'h0100)`nnc_error("ATM12",$sformatf("D2A_SDMBUFF_EN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_SDMBUFF_EN));
    if(`ANA_TOP.D2A_SDMEN !== 16'h0100)`nnc_error("ATM12",$sformatf("D2A_SDMEN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_SDMEN));
   ...
   `nnc_info("Checking ATM - Start", "Checking ATM13 Done", UVM_LOW);
    ...
    if(`ANA_TOP.D2A_BIST_SEL !== 5'b01101)`nnc_error("ATM13",$sformatf("D2A_BIST_SEL error, Real data:%b not match 5'b01101",`ANA_TOP.D2A_BIST_SEL)); 
    if(`ANA_TOP.D2A_BIST_EN !== 1'b1)`nnc_error("ATM13",$sformatf("D2A_BIST_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_BIST_EN)); 
    if(`ANA_TOP.D2A_OSC8MHZEN !== 1'b0)`nnc_error("ATM13",$sformatf("D2A_OSC8MHZEN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_OSC8MHZEN)); 
    if(`ANA_TOP.D2A_BGBUFFER_CPTEST_EN !== 1'b0)`nnc_error("ATM13",$sformatf("D2A_BGBUFFER_CPTEST_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_BGBUFFER_CPTEST_EN));
    if(`ANA_TOP.D2A_RLD_ELECTRODE_EN !== 1'b0)`nnc_error("ATM13",$sformatf("D2A_RLD_ELECTRODE_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_RLD_ELECTRODE_EN));
    if(`ANA_TOP.D2A_VCMGENBUFF_EN !== 1'b0)`nnc_error("ATM13",$sformatf("D2A_VCMGENBUFF_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_VCMGENBUFF_EN));
    if(`ANA_TOP.D2A_SDMVCMBUFF_EN !== 1'b0)`nnc_error("ATM13",$sformatf("D2A_SDMVCMBUFF_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_SDMVCMBUFF_EN));
    if(`ANA_TOP.D2A_SDMVREFPBUFF_EN !== 1'b0)`nnc_error("ATM13",$sformatf("D2A_SDMVREFPBUFF_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_SDMVREFPBUFF_EN));
    if(`ANA_TOP.D2A_EEGLNA_EN !== 16'h0100)`nnc_error("ATM13",$sformatf("D2A_EEFLNA_EN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_EEGLNA_EN));
    if(`ANA_TOP.D2A_EEGPGA_EN !== 16'h0100)`nnc_error("ATM13",$sformatf("D2A_EEFPGA_EN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_EEGPGA_EN));
    if(`ANA_TOP.D2A_SDMBUFF_EN !== 16'h0100)`nnc_error("ATM13",$sformatf("D2A_SDMBUFF_EN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_SDMBUFF_EN));
    if(`ANA_TOP.D2A_SDMEN !== 16'h0100)`nnc_error("ATM13",$sformatf("D2A_SDMEN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_SDMEN));
   ...
   `nnc_info("Checking ATM - Start", "Checking ATM14 Done", UVM_LOW);
    ...
    if(`ANA_TOP.D2A_BIST_SEL !== 5'b01110)`nnc_error("ATM14",$sformatf("D2A_BIST_SEL error, Real data:%b not match 5'b01110",`ANA_TOP.D2A_BIST_SEL)); 
    if(`ANA_TOP.D2A_BIST_EN !== 1'b1)`nnc_error("ATM14",$sformatf("D2A_BIST_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_BIST_EN)); 
    if(`ANA_TOP.D2A_OSC8MHZEN !== 1'b0)`nnc_error("ATM14",$sformatf("D2A_OSC8MHZEN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_OSC8MHZEN)); 
    if(`ANA_TOP.D2A_BGBUFFER_CPTEST_EN !== 1'b0)`nnc_error("ATM14",$sformatf("D2A_BGBUFFER_CPTEST_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_BGBUFFER_CPTEST_EN));
    if(`ANA_TOP.D2A_RLD_ELECTRODE_EN !== 1'b0)`nnc_error("ATM14",$sformatf("D2A_RLD_ELECTRODE_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_RLD_ELECTRODE_EN));
    if(`ANA_TOP.D2A_VCMGENBUFF_EN !== 1'b0)`nnc_error("ATM14",$sformatf("D2A_VCMGENBUFF_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_VCMGENBUFF_EN));
    if(`ANA_TOP.D2A_SDMVCMBUFF_EN !== 1'b0)`nnc_error("ATM14",$sformatf("D2A_SDMVCMBUFF_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_SDMVCMBUFF_EN));
    if(`ANA_TOP.D2A_SDMVREFPBUFF_EN !== 1'b0)`nnc_error("ATM14",$sformatf("D2A_SDMVREFPBUFF_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_SDMVREFPBUFF_EN));
    if(`ANA_TOP.D2A_EEGLNA_EN !== 16'h0100)`nnc_error("ATM14",$sformatf("D2A_EEFLNA_EN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_EEGLNA_EN));
    if(`ANA_TOP.D2A_EEGPGA_EN !== 16'h0100)`nnc_error("ATM14",$sformatf("D2A_EEFPGA_EN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_EEGPGA_EN));
    if(`ANA_TOP.D2A_SDMBUFF_EN !== 16'h0100)`nnc_error("ATM14",$sformatf("D2A_SDMBUFF_EN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_SDMBUFF_EN));
    if(`ANA_TOP.D2A_SDMEN !== 16'h0100)`nnc_error("ATM14",$sformatf("D2A_SDMEN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_SDMEN));
   ...
   `nnc_info("Checking ATM - Start", "Checking ATM15 Done", UVM_LOW);
    ...
    if(`ANA_TOP.D2A_BIST_SEL !== 5'b01111)`nnc_error("ATM15",$sformatf("D2A_BIST_SEL error, Real data:%b not match 5'b01111",`ANA_TOP.D2A_BIST_SEL)); 
    if(`ANA_TOP.D2A_BIST_EN !== 1'b1)`nnc_error("ATM15",$sformatf("D2A_BIST_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_BIST_EN)); 
    if(`ANA_TOP.D2A_OSC8MHZEN !== 1'b0)`nnc_error("ATM15",$sformatf("D2A_OSC8MHZEN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_OSC8MHZEN)); 
    if(`ANA_TOP.D2A_BGBUFFER_CPTEST_EN !== 1'b0)`nnc_error("ATM15",$sformatf("D2A_BGBUFFER_CPTEST_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_BGBUFFER_CPTEST_EN));
    if(`ANA_TOP.D2A_EN_TSC !== 1'b0)`nnc_error("ATM15",$sformatf("D2A_EN_TSC error, Real data:%b not match 1'b0",`ANA_TOP.D2A_EN_TSC));
   `nnc_info("Checking ATM - Done", "Checking ATM15 Done", UVM_LOW);
   ...
   `nnc_info("Checking ATM - Start", "Checking ATM16 Done", UVM_LOW);
    ...
    if(`ANA_TOP.D2A_BIST_SEL !== 5'b10000)`nnc_error("ATM16",$sformatf("D2A_BIST_SEL error, Real data:%b not match 5'b10000",`ANA_TOP.D2A_BIST_SEL)); 
    if(`ANA_TOP.D2A_BIST_EN !== 1'b1)`nnc_error("ATM16",$sformatf("D2A_BIST_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_BIST_EN)); 
    if(`ANA_TOP.D2A_OSC8MHZEN !== 1'b0)`nnc_error("ATM16",$sformatf("D2A_OSC8MHZEN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_OSC8MHZEN)); 
    if(`ANA_TOP.D2A_BGBUFFER_CPTEST_EN !== 1'b0)`nnc_error("ATM16",$sformatf("D2A_BGBUFFER_CPTEST_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_BGBUFFER_CPTEST_EN));
    if(`ANA_TOP.D2A_DCLOFFEN !== 16'h0100)`nnc_error("ATM16",$sformatf("D2A_DCLOFFEN error, Real data:%b not match 16'h0100",`ANA_TOP.D2A_DCLOFFEN));
   `nnc_info("Checking ATM - Done", "Checking ATM16 Done", UVM_LOW);
   ...
   `nnc_info("Checking ATM - Start", "Checking ATM17 Done", UVM_LOW);
    ...
    if(`ANA_TOP.D2A_BIST_SEL !== 5'b10001)`nnc_error("ATM17",$sformatf("D2A_BIST_SEL error, Real data:%b not match 5'b10001",`ANA_TOP.D2A_BIST_SEL)); 
    if(`ANA_TOP.D2A_BIST_EN !== 1'b1)`nnc_error("ATM17",$sformatf("D2A_BIST_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_BIST_EN)); 
    if(`ANA_TOP.D2A_OSC8MHZEN !== 1'b0)`nnc_error("ATM17",$sformatf("D2A_OSC8MHZEN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_OSC8MHZEN)); 
    if(`ANA_TOP.D2A_BGBUFFER_CPTEST_EN !== 1'b0)`nnc_error("ATM17",$sformatf("D2A_BGBUFFER_CPTEST_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_BGBUFFER_CPTEST_EN));
    if(`ANA_TOP.D2A_DCLOFFEN !== 16'h0100)`nnc_error("ATM17",$sformatf("D2A_DCLOFFEN error, Real data:%b not match 16'h0100",`ANA_TOP.D2A_DCLOFFEN));
   `nnc_info("Checking ATM - Done", "Checking ATM17 Done", UVM_LOW);
   ...
   `nnc_info("Checking ATM - Start", "Checking ATM18 Done", UVM_LOW);
    ...
    if(`ANA_TOP.D2A_BIST_SEL !== 5'b10010)`nnc_error("ATM18",$sformatf("D2A_BIST_SEL error, Real data:%b not match 5'b10010",`ANA_TOP.D2A_BIST_SEL)); 
    if(`ANA_TOP.D2A_BIST_EN !== 1'b1)`nnc_error("ATM18",$sformatf("D2A_BIST_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_BIST_EN)); 
    if(`ANA_TOP.D2A_OSC8MHZEN !== 1'b0)`nnc_error("ATM18",$sformatf("D2A_OSC8MHZEN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_OSC8MHZEN)); 
    if(`ANA_TOP.D2A_BGBUFFER_CPTEST_EN !== 1'b0)`nnc_error("ATM18",$sformatf("D2A_BGBUFFER_CPTEST_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_BGBUFFER_CPTEST_EN));
    if(`ANA_TOP.D2A_NIRS4_EN !== 1'b1)`nnc_error("ATM18",$sformatf("D2A_NIRS4_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_NIRS4_EN));
    if(`ANA_TOP.D2A_NIRS_TEST_EN !== 1'b1)`nnc_error("ATM18",$sformatf("D2A_NIRS_TEST_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_NIRS_TEST_EN));
   `nnc_info("Checking ATM - Done", "Checking ATM18 Done", UVM_LOW);
   ...
   `nnc_info("Checking ATM - Start", "Checking ATM19 Done", UVM_LOW);
    ...
    if(`ANA_TOP.D2A_BIST_SEL !== 5'b10011)`nnc_error("ATM19",$sformatf("D2A_BIST_SEL error, Real data:%b not match 5'b10011",`ANA_TOP.D2A_BIST_SEL)); 
    if(`ANA_TOP.D2A_BIST_EN !== 1'b1)`nnc_error("ATM19",$sformatf("D2A_BIST_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_BIST_EN)); 
    if(`ANA_TOP.D2A_OSC8MHZEN !== 1'b0)`nnc_error("ATM19",$sformatf("D2A_OSC8MHZEN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_OSC8MHZEN)); 
    if(`ANA_TOP.D2A_BGBUFFER_CPTEST_EN !== 1'b0)`nnc_error("ATM19",$sformatf("D2A_BGBUFFER_CPTEST_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_BGBUFFER_CPTEST_EN));
    if(`ANA_TOP.D2A_NIRS4_EN !== 1'b1)`nnc_error("ATM19",$sformatf("D2A_NIRS4_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_NIRS4_EN));
    if(`ANA_TOP.D2A_NIRS_TEST_EN !== 1'b1)`nnc_error("ATM19",$sformatf("D2A_NIRS_TEST_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_NIRS_TEST_EN));
   `nnc_info("Checking ATM - Done", "Checking ATM19 Done", UVM_LOW);
   ...
   `nnc_info("Checking ATM - Start", "Checking ATM20 Done", UVM_LOW);
    ...
    if(`ANA_TOP.D2A_BIST_SEL !== 5'b10100)`nnc_error("ATM20",$sformatf("D2A_BIST_SEL error, Real data:%b not match 5'b10100",`ANA_TOP.D2A_BIST_SEL)); 
    if(`ANA_TOP.D2A_BIST_EN !== 1'b1)`nnc_error("ATM20",$sformatf("D2A_BIST_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_BIST_EN)); 
    if(`ANA_TOP.D2A_OSC8MHZEN !== 1'b0)`nnc_error("ATM20",$sformatf("D2A_OSC8MHZEN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_OSC8MHZEN)); 
    if(`ANA_TOP.D2A_BGBUFFER_CPTEST_EN !== 1'b0)`nnc_error("ATM20",$sformatf("D2A_BGBUFFER_CPTEST_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_BGBUFFER_CPTEST_EN));
    if(`ANA_TOP.D2A_NIRS4_EN !== 1'b1)`nnc_error("ATM20",$sformatf("D2A_NIRS4_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_NIRS4_EN));
    if(`ANA_TOP.D2A_NIRS4_IDAC_EN !== 1'b1)`nnc_error("ATM20",$sformatf("D2A_NIRS4_IDAC_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_NIRS4_IDAC_EN));
    if(`ANA_TOP.D2A_NIRS_TEST_EN !== 1'b1)`nnc_error("ATM20",$sformatf("D2A_NIRS_TEST_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_NIRS_TEST_EN));
   `nnc_info("Checking ATM - Done", "Checking ATM20 Done", UVM_LOW);
   ...
   `nnc_info("Checking ATM - Start", "Checking ATM21 Done", UVM_LOW);
    ...
    if(`ANA_TOP.D2A_BIST_SEL !== 5'b10101)`nnc_error("ATM21",$sformatf("D2A_BIST_SEL error, Real data:%b not match 5'b10101",`ANA_TOP.D2A_BIST_SEL)); 
    if(`ANA_TOP.D2A_BIST_EN !== 1'b1)`nnc_error("ATM21",$sformatf("D2A_BIST_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_BIST_EN)); 
    if(`ANA_TOP.D2A_OSC8MHZEN !== 1'b0)`nnc_error("ATM21",$sformatf("D2A_OSC8MHZEN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_OSC8MHZEN)); 
    if(`ANA_TOP.D2A_BGBUFFER_CPTEST_EN !== 1'b0)`nnc_error("ATM21",$sformatf("D2A_BGBUFFER_CPTEST_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_BGBUFFER_CPTEST_EN));
    if(`ANA_TOP.D2A_RLD_ELECTRODE_EN !== 1'b0)`nnc_error("ATM21",$sformatf("D2A_RLD_ELECTRODE_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_RLD_ELECTRODE_EN));
    if(`ANA_TOP.D2A_VCMGENBUFF_EN !== 1'b0)`nnc_error("ATM21",$sformatf("D2A_VCMGENBUFF_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_VCMGENBUFF_EN));
    if(`ANA_TOP.D2A_SDMVCMBUFF_EN !== 1'b0)`nnc_error("ATM21",$sformatf("D2A_SDMVCMBUFF_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_SDMVCMBUFF_EN));
    if(`ANA_TOP.D2A_SDMVREFPBUFF_EN !== 1'b0)`nnc_error("ATM21",$sformatf("D2A_SDMVREFPBUFF_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_SDMVREFPBUFF_EN));
    if(`ANA_TOP.D2A_EEGLNA_EN !== 16'h0100)`nnc_error("ATM21",$sformatf("D2A_EEFLNA_EN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_EEGLNA_EN));
    if(`ANA_TOP.D2A_EEGPGA_EN !== 16'h0100)`nnc_error("ATM21",$sformatf("D2A_EEFPGA_EN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_EEGPGA_EN));
    if(`ANA_TOP.D2A_SDMBUFF_EN !== 16'h0100)`nnc_error("ATM21",$sformatf("D2A_SDMBUFF_EN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_SDMBUFF_EN));
    if(`ANA_TOP.D2A_SDMEN !== 16'h0100)`nnc_error("ATM21",$sformatf("D2A_SDMEN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_SDMEN));
   ...
   `nnc_info("Checking ATM - Start", "Checking ATM22 Done", UVM_LOW);
    ...
    if(`ANA_TOP.D2A_BIST_SEL !== 5'b10110)`nnc_error("ATM22",$sformatf("D2A_BIST_SEL error, Real data:%b not match 5'b10110",`ANA_TOP.D2A_BIST_SEL)); 
    if(`ANA_TOP.D2A_BIST_EN !== 1'b1)`nnc_error("ATM22",$sformatf("D2A_BIST_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_BIST_EN)); 
    if(`ANA_TOP.D2A_OSC8MHZEN !== 1'b0)`nnc_error("ATM22",$sformatf("D2A_OSC8MHZEN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_OSC8MHZEN)); 
    if(`ANA_TOP.D2A_BGBUFFER_CPTEST_EN !== 1'b0)`nnc_error("ATM22",$sformatf("D2A_BGBUFFER_CPTEST_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_BGBUFFER_CPTEST_EN));
    if(`ANA_TOP.D2A_RLD_ELECTRODE_EN !== 1'b0)`nnc_error("ATM22",$sformatf("D2A_RLD_ELECTRODE_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_RLD_ELECTRODE_EN));
    if(`ANA_TOP.D2A_VCMGENBUFF_EN !== 1'b0)`nnc_error("ATM22",$sformatf("D2A_VCMGENBUFF_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_VCMGENBUFF_EN));
    if(`ANA_TOP.D2A_SDMVCMBUFF_EN !== 1'b0)`nnc_error("ATM22",$sformatf("D2A_SDMVCMBUFF_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_SDMVCMBUFF_EN));
    if(`ANA_TOP.D2A_SDMVREFPBUFF_EN !== 1'b0)`nnc_error("ATM22",$sformatf("D2A_SDMVREFPBUFF_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_SDMVREFPBUFF_EN));
    if(`ANA_TOP.D2A_EEGLNA_EN !== 16'h0100)`nnc_error("ATM22",$sformatf("D2A_EEFLNA_EN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_EEGLNA_EN));
    if(`ANA_TOP.D2A_EEGPGA_EN !== 16'h0100)`nnc_error("ATM22",$sformatf("D2A_EEFPGA_EN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_EEGPGA_EN));
    if(`ANA_TOP.D2A_SDMBUFF_EN !== 16'h0100)`nnc_error("ATM22",$sformatf("D2A_SDMBUFF_EN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_SDMBUFF_EN));
    if(`ANA_TOP.D2A_SDMEN !== 16'h0100)`nnc_error("ATM22",$sformatf("D2A_SDMEN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_SDMEN));
   ...
   `nnc_info("Checking ATM - Start", "Checking ATM23 Done", UVM_LOW);
    ...
    if(`ANA_TOP.D2A_BIST_SEL !== 5'b10111)`nnc_error("ATM23",$sformatf("D2A_BIST_SEL error, Real data:%b not match 5'b10111",`ANA_TOP.D2A_BIST_SEL)); 
    if(`ANA_TOP.D2A_BIST_EN !== 1'b1)`nnc_error("ATM23",$sformatf("D2A_BIST_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_BIST_EN)); 
    if(`ANA_TOP.D2A_OSC8MHZEN !== 1'b0)`nnc_error("ATM23",$sformatf("D2A_OSC8MHZEN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_OSC8MHZEN)); 
    if(`ANA_TOP.D2A_BGBUFFER_CPTEST_EN !== 1'b0)`nnc_error("ATM23",$sformatf("D2A_BGBUFFER_CPTEST_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_BGBUFFER_CPTEST_EN));
    if(`ANA_TOP.D2A_RLD_ELECTRODE_EN !== 1'b0)`nnc_error("ATM23",$sformatf("D2A_RLD_ELECTRODE_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_RLD_ELECTRODE_EN));
    if(`ANA_TOP.D2A_VCMGENBUFF_EN !== 1'b0)`nnc_error("ATM23",$sformatf("D2A_VCMGENBUFF_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_VCMGENBUFF_EN));
    if(`ANA_TOP.D2A_SDMVCMBUFF_EN !== 1'b0)`nnc_error("ATM23",$sformatf("D2A_SDMVCMBUFF_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_SDMVCMBUFF_EN));
    if(`ANA_TOP.D2A_SDMVREFPBUFF_EN !== 1'b0)`nnc_error("ATM23",$sformatf("D2A_SDMVREFPBUFF_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_SDMVREFPBUFF_EN));
    if(`ANA_TOP.D2A_EEGLNA_EN !== 16'h0100)`nnc_error("ATM23",$sformatf("D2A_EEFLNA_EN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_EEGLNA_EN));
    if(`ANA_TOP.D2A_EEGPGA_EN !== 16'h0100)`nnc_error("ATM23",$sformatf("D2A_EEFPGA_EN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_EEGPGA_EN));
    if(`ANA_TOP.D2A_SDMBUFF_EN !== 16'h0100)`nnc_error("ATM23",$sformatf("D2A_SDMBUFF_EN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_SDMBUFF_EN));
    if(`ANA_TOP.D2A_SDMEN !== 16'h0100)`nnc_error("ATM23",$sformatf("D2A_SDMEN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_SDMEN));
   ...
   `nnc_info("Checking ATM - Start", "Checking ATM24 Done", UVM_LOW);
    ...
    if(`ANA_TOP.D2A_BIST_SEL !== 5'b11000)`nnc_error("ATM24",$sformatf("D2A_BIST_SEL error, Real data:%b not match 5'b11000",`ANA_TOP.D2A_BIST_SEL)); 
    if(`ANA_TOP.D2A_BIST_EN !== 1'b1)`nnc_error("ATM24",$sformatf("D2A_BIST_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_BIST_EN)); 
    if(`ANA_TOP.D2A_OSC8MHZEN !== 1'b0)`nnc_error("ATM24",$sformatf("D2A_OSC8MHZEN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_OSC8MHZEN)); 
    if(`ANA_TOP.D2A_BGBUFFER_CPTEST_EN !== 1'b0)`nnc_error("ATM24",$sformatf("D2A_BGBUFFER_CPTEST_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_BGBUFFER_CPTEST_EN));
    if(`ANA_TOP.D2A_RLD_ELECTRODE_EN !== 1'b0)`nnc_error("ATM24",$sformatf("D2A_RLD_ELECTRODE_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_RLD_ELECTRODE_EN));
    if(`ANA_TOP.D2A_VCMGENBUFF_EN !== 1'b0)`nnc_error("ATM24",$sformatf("D2A_VCMGENBUFF_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_VCMGENBUFF_EN));
    if(`ANA_TOP.D2A_SDMVCMBUFF_EN !== 1'b0)`nnc_error("ATM24",$sformatf("D2A_SDMVCMBUFF_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_SDMVCMBUFF_EN));
    if(`ANA_TOP.D2A_SDMVREFPBUFF_EN !== 1'b0)`nnc_error("ATM24",$sformatf("D2A_SDMVREFPBUFF_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_SDMVREFPBUFF_EN));
    if(`ANA_TOP.D2A_EEGLNA_EN !== 16'h0100)`nnc_error("ATM24",$sformatf("D2A_EEFLNA_EN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_EEGLNA_EN));
    if(`ANA_TOP.D2A_EEGPGA_EN !== 16'h0100)`nnc_error("ATM24",$sformatf("D2A_EEFPGA_EN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_EEGPGA_EN));
    if(`ANA_TOP.D2A_SDMBUFF_EN !== 16'h0100)`nnc_error("ATM24",$sformatf("D2A_SDMBUFF_EN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_SDMBUFF_EN));
    if(`ANA_TOP.D2A_SDMEN !== 16'h0100)`nnc_error("ATM24",$sformatf("D2A_SDMEN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_SDMEN));
   ...
   `nnc_info("Checking ATM - Start", "Checking ATM25 Done", UVM_LOW);
    ...
    if(`ANA_TOP.D2A_BIST_SEL !== 5'b11001)`nnc_error("ATM25",$sformatf("D2A_BIST_SEL error, Real data:%b not match 5'b11001",`ANA_TOP.D2A_BIST_SEL)); 
    if(`ANA_TOP.D2A_BIST_EN !== 1'b1)`nnc_error("ATM25",$sformatf("D2A_BIST_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_BIST_EN)); 
    if(`ANA_TOP.D2A_OSC8MHZEN !== 1'b0)`nnc_error("ATM25",$sformatf("D2A_OSC8MHZEN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_OSC8MHZEN)); 
    if(`ANA_TOP.D2A_BGBUFFER_CPTEST_EN !== 1'b0)`nnc_error("ATM25",$sformatf("D2A_BGBUFFER_CPTEST_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_BGBUFFER_CPTEST_EN));
    if(`ANA_TOP.D2A_RLD_ELECTRODE_EN !== 1'b0)`nnc_error("ATM25",$sformatf("D2A_RLD_ELECTRODE_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_RLD_ELECTRODE_EN));
    if(`ANA_TOP.D2A_VCMGENBUFF_EN !== 1'b0)`nnc_error("ATM25",$sformatf("D2A_VCMGENBUFF_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_VCMGENBUFF_EN));
    if(`ANA_TOP.D2A_SDMVCMBUFF_EN !== 1'b0)`nnc_error("ATM25",$sformatf("D2A_SDMVCMBUFF_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_SDMVCMBUFF_EN));
    if(`ANA_TOP.D2A_SDMVREFPBUFF_EN !== 1'b0)`nnc_error("ATM25",$sformatf("D2A_SDMVREFPBUFF_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_SDMVREFPBUFF_EN));
    if(`ANA_TOP.D2A_EEGLNA_EN !== 16'h0100)`nnc_error("ATM25",$sformatf("D2A_EEFLNA_EN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_EEGLNA_EN));
    if(`ANA_TOP.D2A_EEGPGA_EN !== 16'h0100)`nnc_error("ATM25",$sformatf("D2A_EEFPGA_EN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_EEGPGA_EN));
    if(`ANA_TOP.D2A_SDMBUFF_EN !== 16'h0100)`nnc_error("ATM25",$sformatf("D2A_SDMBUFF_EN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_SDMBUFF_EN));
    if(`ANA_TOP.D2A_SDMEN !== 16'h0100)`nnc_error("ATM25",$sformatf("D2A_SDMEN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_SDMEN));
   ...
   `nnc_info("Checking ATM - Start", "Checking ATM26 Done", UVM_LOW);
    ...
    if(`ANA_TOP.D2A_BIST_SEL !== 5'b11010)`nnc_error("ATM26",$sformatf("D2A_BIST_SEL error, Real data:%b not match 5'b11010",`ANA_TOP.D2A_BIST_SEL)); 
    if(`ANA_TOP.D2A_BIST_EN !== 1'b1)`nnc_error("ATM26",$sformatf("D2A_BIST_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_BIST_EN)); 
    if(`ANA_TOP.D2A_OSC8MHZEN !== 1'b0)`nnc_error("ATM26",$sformatf("D2A_OSC8MHZEN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_OSC8MHZEN)); 
    if(`ANA_TOP.D2A_BGBUFFER_CPTEST_EN !== 1'b0)`nnc_error("ATM26",$sformatf("D2A_BGBUFFER_CPTEST_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_BGBUFFER_CPTEST_EN));
    if(`ANA_TOP.D2A_RLD_ELECTRODE_EN !== 1'b0)`nnc_error("ATM26",$sformatf("D2A_RLD_ELECTRODE_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_RLD_ELECTRODE_EN));
    if(`ANA_TOP.D2A_VCMGENBUFF_EN !== 1'b0)`nnc_error("ATM26",$sformatf("D2A_VCMGENBUFF_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_VCMGENBUFF_EN));
    if(`ANA_TOP.D2A_SDMVCMBUFF_EN !== 1'b0)`nnc_error("ATM26",$sformatf("D2A_SDMVCMBUFF_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_SDMVCMBUFF_EN));
    if(`ANA_TOP.D2A_SDMVREFPBUFF_EN !== 1'b0)`nnc_error("ATM26",$sformatf("D2A_SDMVREFPBUFF_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_SDMVREFPBUFF_EN));
    if(`ANA_TOP.D2A_EEGLNA_EN !== 16'h0100)`nnc_error("ATM26",$sformatf("D2A_EEFLNA_EN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_EEGLNA_EN));
    if(`ANA_TOP.D2A_EEGPGA_EN !== 16'h0100)`nnc_error("ATM26",$sformatf("D2A_EEFPGA_EN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_EEGPGA_EN));
    if(`ANA_TOP.D2A_SDMBUFF_EN !== 16'h0100)`nnc_error("ATM26",$sformatf("D2A_SDMBUFF_EN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_SDMBUFF_EN));
    if(`ANA_TOP.D2A_SDMEN !== 16'h0100)`nnc_error("ATM26",$sformatf("D2A_SDMEN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_SDMEN));
   ...
   `nnc_info("Checking ATM - Start", "Checking ATM27 Done", UVM_LOW);
    ...
    if(`ANA_TOP.D2A_BIST_SEL !== 5'b11011)`nnc_error("ATM27",$sformatf("D2A_BIST_SEL error, Real data:%b not match 5'b11011",`ANA_TOP.D2A_BIST_SEL)); 
    if(`ANA_TOP.D2A_BIST_EN !== 1'b1)`nnc_error("ATM27",$sformatf("D2A_BIST_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_BIST_EN)); 
    if(`ANA_TOP.D2A_OSC8MHZEN !== 1'b0)`nnc_error("ATM27",$sformatf("D2A_OSC8MHZEN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_OSC8MHZEN)); 
    if(`ANA_TOP.D2A_BGBUFFER_CPTEST_EN !== 1'b0)`nnc_error("ATM27",$sformatf("D2A_BGBUFFER_CPTEST_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_BGBUFFER_CPTEST_EN));
    if(`ANA_TOP.D2A_RLD_ELECTRODE_EN !== 1'b0)`nnc_error("ATM27",$sformatf("D2A_RLD_ELECTRODE_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_RLD_ELECTRODE_EN));
    if(`ANA_TOP.D2A_VCMGENBUFF_EN !== 1'b0)`nnc_error("ATM27",$sformatf("D2A_VCMGENBUFF_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_VCMGENBUFF_EN));
    if(`ANA_TOP.D2A_SDMVCMBUFF_EN !== 1'b0)`nnc_error("ATM27",$sformatf("D2A_SDMVCMBUFF_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_SDMVCMBUFF_EN));
    if(`ANA_TOP.D2A_SDMVREFPBUFF_EN !== 1'b0)`nnc_error("ATM27",$sformatf("D2A_SDMVREFPBUFF_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_SDMVREFPBUFF_EN));
    if(`ANA_TOP.D2A_EEGLNA_EN !== 16'h0100)`nnc_error("ATM27",$sformatf("D2A_EEFLNA_EN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_EEGLNA_EN));
    if(`ANA_TOP.D2A_EEGPGA_EN !== 16'h0100)`nnc_error("ATM27",$sformatf("D2A_EEFPGA_EN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_EEGPGA_EN));
    if(`ANA_TOP.D2A_SDMBUFF_EN !== 16'h0100)`nnc_error("ATM27",$sformatf("D2A_SDMBUFF_EN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_SDMBUFF_EN));
    if(`ANA_TOP.D2A_SDMEN !== 16'h0100)`nnc_error("ATM27",$sformatf("D2A_SDMEN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_SDMEN));
   ...
   `nnc_info("Checking ATM - Start", "Checking ATM28 Done", UVM_LOW);
    ...
    if(`ANA_TOP.D2A_BIST_SEL !== 5'b11100)`nnc_error("ATM28",$sformatf("D2A_BIST_SEL error, Real data:%b not match 5'b11100",`ANA_TOP.D2A_BIST_SEL)); 
    if(`ANA_TOP.D2A_BIST_EN !== 1'b1)`nnc_error("ATM28",$sformatf("D2A_BIST_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_BIST_EN)); 
    if(`ANA_TOP.D2A_OSC8MHZEN !== 1'b0)`nnc_error("ATM28",$sformatf("D2A_OSC8MHZEN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_OSC8MHZEN)); 
    if(`ANA_TOP.D2A_BGBUFFER_CPTEST_EN !== 1'b0)`nnc_error("ATM28",$sformatf("D2A_BGBUFFER_CPTEST_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_BGBUFFER_CPTEST_EN));
    if(`ANA_TOP.D2A_RLD_ELECTRODE_EN !== 1'b0)`nnc_error("ATM28",$sformatf("D2A_RLD_ELECTRODE_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_RLD_ELECTRODE_EN));
    if(`ANA_TOP.D2A_VCMGENBUFF_EN !== 1'b0)`nnc_error("ATM28",$sformatf("D2A_VCMGENBUFF_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_VCMGENBUFF_EN));
    if(`ANA_TOP.D2A_SDMVCMBUFF_EN !== 1'b0)`nnc_error("ATM28",$sformatf("D2A_SDMVCMBUFF_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_SDMVCMBUFF_EN));
    if(`ANA_TOP.D2A_SDMVREFPBUFF_EN !== 1'b0)`nnc_error("ATM28",$sformatf("D2A_SDMVREFPBUFF_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_SDMVREFPBUFF_EN));
    if(`ANA_TOP.D2A_EEGLNA_EN !== 16'h0100)`nnc_error("ATM28",$sformatf("D2A_EEFLNA_EN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_EEGLNA_EN));
    if(`ANA_TOP.D2A_EEGPGA_EN !== 16'h0100)`nnc_error("ATM28",$sformatf("D2A_EEFPGA_EN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_EEGPGA_EN));
    if(`ANA_TOP.D2A_SDMBUFF_EN !== 16'h0100)`nnc_error("ATM28",$sformatf("D2A_SDMBUFF_EN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_SDMBUFF_EN));
    if(`ANA_TOP.D2A_SDMEN !== 16'h0100)`nnc_error("ATM28",$sformatf("D2A_SDMEN error, Real data:%4h not match 16'h0100",`ANA_TOP.D2A_SDMEN));
   ...
   `nnc_info("Checking ATM - Start", "Checking ATM29 Done", UVM_LOW);
    ...
    if(`ANA_TOP.D2A_BIST_SEL !== 5'b11101)`nnc_error("ATM29",$sformatf("D2A_BIST_SEL error, Real data:%b not match 5'b11101",`ANA_TOP.D2A_BIST_SEL)); 
    if(`ANA_TOP.D2A_BIST_EN !== 1'b1)`nnc_error("ATM29",$sformatf("D2A_BIST_EN error, Real data:%b not match 1'b1",`ANA_TOP.D2A_BIST_EN)); 
    if(`ANA_TOP.D2A_OSC8MHZEN !== 1'b0)`nnc_error("ATM29",$sformatf("D2A_OSC8MHZEN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_OSC8MHZEN)); 
    if(`ANA_TOP.D2A_BGBUFFER_CPTEST_EN !== 1'b0)`nnc_error("ATM29",$sformatf("D2A_BGBUFFER_CPTEST_EN error, Real data:%b not match 1'b0",`ANA_TOP.D2A_BGBUFFER_CPTEST_EN));
    if(`ANA_TOP.D2A_EN_TSC !== 1'b0)`nnc_error("ATM29",$sformatf("D2A_EN_TSC error, Real data:%b not match 1'b0",`ANA_TOP.D2A_EN_TSC));
   `nnc_info("Checking ATM - Done", "Checking ATM29 Done", UVM_LOW);
