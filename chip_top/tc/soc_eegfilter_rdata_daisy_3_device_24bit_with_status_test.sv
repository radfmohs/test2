...
//--------------------------------------------------------------------------------------
// File Name	: soc_eegfilter_rdata_daisy_3_device_24bit_with_status_test.sv                                                   
// Project	: Nanochap ENS2                                  		        
// Description	: Testcase soc_eegfilter_rdata_daisy_3_device_24bit_with_status_test                                             
// Designer	: shreeyal@nanochap.com                                                                 
// Date		: 05-09-2025                                                                     
// Revision	: 0.1 Initial version created by script                                 
--------------------------------------------------------------------------------------*/
`define TESTNAME soc_eegfilter_rdata_daisy_3_device_24bit_with_status_test
`define TESTCFG soc_eegfilter_rdata_daisy_3_device_24bit_with_status_test_cfg
...
class `TESTCFG extends soc_eegfilter_rdata_daisy_test_cfg;
  ...
  function new (string name = "soc_eegfilter_rdata_daisy_3_device_24bit_with_status_test_cfg");
    super.new(name);
  endfunction: new
  ...
  constraint c_imeas_24bitdata_en { imeas_24bitdata_en == 1; }// 24 bit data

  constraint c_imeas_cic_rate      { imeas_cic_rate == 5;} // 24 bit - 8Khz - 3 device 
...
class `TESTNAME extends soc_eegfilter_rdata_daisy_test;
  ...
  virtual task main_phase(uvm_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_eegfilter_rdata_daisy_3_device_24bit_with_status_test start now", UVM_LOW)
    super.main_phase(phase);
    `nnc_info("SOC_TEST", "soc_eegfilter_rdata_daisy_3_device_24bit_with_status_test end now", UVM_LOW)
    // ----------------------------------------------------------------------------------
    // End of adding test 
    // ----------------------------------------------------------------------------------
