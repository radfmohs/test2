...
//--------------------------------------------------------------------------------------
// File Name	: soc_app_demo_scenario_sine_pulsewave_test.sv                                                   
// Project	: Nanochap ENS2                                  		        
// Description	: Testcase soc_app_demo_scenario_sine_pulsewave_test                                             
...
//************************************************************************************
// NOTE : This test checks the leadoff and after that short for sine-pulsewave 
//************************************************************************************

// =================================================
// Testcase name is defined
// -------------------------------------------------
`define TESTNAME soc_app_demo_scenario_sine_pulsewave_test
`define TESTCFG soc_app_demo_scenario_sine_pulsewave_test_cfg
...
class `TESTCFG extends soc_app_demo_scenario_base_test_cfg;
  ...
  //preload_sel
  constraint c_preload_sel     { preload_sel inside {0,0};} // 0: sine_pulse

  //constraint c_waveform_sel    { (preload_sel == 2'b01) -> waveform_sel == 0; 
  //                               (preload_sel == 2'b11) -> waveform_sel inside {[0:2]};} // 

  constraint c_waveform_sel    { waveform_sel == 1;} // waveform_sel should be 1 to get sine-pulsewave
...
class `TESTNAME extends soc_app_demo_scenario_base_test;
  ...
  virtual task main_phase(nnc_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_app_demo_scenario_sine_pulsewave_test start", NNC_LOW)
    super.main_phase(phase);
    `nnc_info("SOC_TEST", "soc_app_demo_scenario_sine_pulsewave_test end now", NNC_LOW)
