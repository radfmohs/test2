...
//--------------------------------------------------------------------------------------
// File Name	: soc_spi_simple_test.sv                                                   
// Project	: Nanochap ENS2                                  		        
// Description	: Testcase soc_spi_simple_test                                             
// Designer	: philp@nanochap.com                                                                 
// Date		: 29-05-2026                                                                     
...
// -------------------------------------------------
`define TESTNAME soc_spi_simple_test
`define TESTCFG soc_spi_simple_test_cfg
...
class `TESTCFG extends soc_base_test_cfg;
  ...
  function new (string name = "soc_spi_simple_test_cfg");
    super.new(name);
...
class `TESTNAME extends soc_base_test;
  ...
  virtual task main_phase(nnc_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_spi_simple_test start", NNC_LOW)
    ...
    // --------------------------------------------------------
    #10000ns;
    `nnc_info("SOC_TEST", "soc_spi_simple_test end now", NNC_LOW)
