...
//--------------------------------------------------------------------------------------
// File Name	: soc_spi_reg_extended_min_test.sv                                                   
// Project	: Nanochap ENS2                                  		        
// Description	: Testcase soc_spi_reg_extended_min_test                                             
...
// -------------------------------------------------
`define TESTNAME soc_spi_reg_extended_min_test
`define TESTCFG soc_spi_reg_extended_min_test_cfg
...
class `TESTCFG extends soc_spi_reg_test_cfg;
  ...
  function new (string name = "soc_spi_reg_extended_min_test_cfg");
    super.new(name);
  endfunction: new
  ...
  constraint c_spi_sclk_freq          {  spi_sclk_freq == 25;} //25KHZ min SPI Clk
...
class `TESTNAME extends soc_spi_reg_test;
  ...
  virtual task main_phase(nnc_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_spi_reg_extended_min_test start", NNC_LOW)
    ...
    // --------------------------------------------------------
    `nnc_info("SOC_TEST", "soc_spi_reg_extended_min_test end now", NNC_LOW)
