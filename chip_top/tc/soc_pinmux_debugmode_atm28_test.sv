...
`else
        if (`ANA_WRAPPER_TOP.pinmux_if_D2A_ADJ_IO[111:104]!== {rand_num[7:0]}) begin
        `nnc_error("ATM28", $sformatf("`SOC_TOP.pinmux_if_D2A_ADJ_IO[111:104] = %b is not as expectation of = %b", `ANA_WRAPPER_TOP.pinmux_if_D2A_ADJ_IO[111:104], {rand_num[7:0]}));
        end
`endif
