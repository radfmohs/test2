...
`else
        if (`ANA_WRAPPER_TOP.pinmux_if_D2A_TRIM_SIG[31:24]!== {rand_num[7:0]}) begin
        `nnc_error("ATM3", $sformatf("`SOC_TOP.pinmux_if_D2A_TRIM_SIG[31:24] = %b is not as expectation of = %b", `ANA_WRAPPER_TOP.pinmux_if_D2A_TRIM_SIG[31:24], {rand_num[7:0]}));
        end
`endif
