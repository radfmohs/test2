...
//--------------------------------------------------------------------------------------
// File Name	: soc_nirs_ppg_receiver_master_cont_typ_mode_test.sv                                                   
// Project	: Nanochap ENS2                                  		        
// Description	: Testcase soc_nirs_ppg_receiver_master_cont_typ_mode_test                                             
...
// -------------------------------------------------
`define TESTNAME soc_nirs_ppg_receiver_master_cont_typ_mode_test
`define TESTCFG soc_nirs_ppg_receiver_master_cont_typ_mode_test_cfg
...
class `TESTCFG extends soc_nirs_ppg_base_test_cfg;
  ...
  function new (string name = "soc_nirs_ppg_receiver_master_cont_typ_mode_test_cfg");
    super.new(name);
  ...
  //
  //constraint c_nirs_ppg_mode_sel { nirs_ppg_mode_sel == 0;} //receiver master continuous typical mode(D2A_NIRS_EN follows counter)
  ...
  // set FF
  //NIRS_CTRL_6
  //constraint c_threshold_h_18_13              {threshold_h_18_13  inside {[0:0]};}
  //NIRS_CTRL_7
  //constraint c_threshold_h_12_5               {threshold_h_12_5  inside {[24:24]};} //[7:7]
  //NIRS_CTRL_8
  //constraint c_threshold_h_4_0                {threshold_h_4_0  inside {[0:0]};} //[31:31]
  //
...
class `TESTNAME extends soc_nirs_ppg_base_test;
  ...
  virtual task main_phase(nnc_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_nirs_ppg_receiver_master_cont_typ_mode_test start", NNC_LOW)
...
//       //Case 1:
//       //1)MCU sets MODE_SEL to 4'b0100(RECEIVER MASTER CONT MODE, TYP)
...
//    
    ...
    // --------------------------------------------------------
    #10000ns;
    `nnc_info("SOC_TEST", "soc_nirs_ppg_receiver_master_cont_typ_mode_test end now", NNC_LOW)
