...
//--------------------------------------------------------------------------------------
// File Name	: soc_imeas_notch_hpf_test.sv                                                   
// Project	: Nanochap ENS2                                  		        
// Description	: Testcase soc_imeas_notch_hpf_test                                             
// Designer	: shreeyal@nanochap.com                                                                 
// Date		: 10-11-2025                                                                     
// Revision	: 0.1 Initial version created by script                                 
--------------------------------------------------------------------------------------*/
`define TESTNAME soc_imeas_notch_hpf_test
`define TESTCFG soc_imeas_notch_hpf_test_cfg
...
class `TESTCFG extends soc_imeas_lpf_notch_hpf_test_cfg;
  ...
  function new (string name = "soc_imeas_notch_hpf_test_cfg");
    super.new(name);
  endfunction: new
  ...
  constraint c_lpf_enable     {  lpf_enable == 0 ;} // lpf disable case
...
class `TESTNAME extends soc_imeas_lpf_notch_hpf_test;
  ...
  virtual task main_phase(uvm_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_imeas_notch_hpf_test end now", UVM_LOW)
    // ----------------------------------------------------------------------------------
    // End of adding test 
    // ----------------------------------------------------------------------------------
