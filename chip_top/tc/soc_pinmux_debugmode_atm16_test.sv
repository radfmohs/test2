...
`endif  
    ...
    if (`ANA_TOP.D2A_DCLOFFEN !== 1'b1)
      begin
        `nnc_error("ATM16", $sformatf("D2A_DCLOFFEN = %b is not as expectation of 1'b1", `ANA_TOP.D2A_DCLOFFEN))
      end
    ...
    if (`ANA_TOP.D2A_OSC8MHZEN !== 1'b0)
      begin
        `nnc_error("ATM16", $sformatf("D2A_OSC8MHZEN = %b is not as expectation of 1'b0", `ANA_TOP.D2A_OSC8MHZEN))
      end 
