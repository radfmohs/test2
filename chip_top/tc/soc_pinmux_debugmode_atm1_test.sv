...
`else
        if (`ANA_WRAPPER_TOP.pinmux_if_D2A_TRIM_SIG[15:8]!== {rand_num[7:0]}) begin
        `nnc_error("ATM1", $sformatf("`SOC_TOP.pinmux_if.D2A_TRIM_SIG[7:0] = %b is not as expectation of = %b", `ANA_WRAPPER_TOP.pinmux_if_D2A_TRIM_SIG[15:8], {rand_num[7:0]}));
        end
`endif
