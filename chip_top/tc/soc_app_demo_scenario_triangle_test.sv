...
//--------------------------------------------------------------------------------------
// File Name	: soc_app_demo_scenario_triangle_test.sv                                                   
// Project	: Nanochap ENS2                                  		        
// Description	: Testcase soc_app_demo_scenario_triangle_test                                             
...
//************************************************************************************
// NOTE : This test checks the leadoff and after that short for trianglewave 
//************************************************************************************

// =================================================
// Testcase name is defined
// -------------------------------------------------
`define TESTNAME soc_app_demo_scenario_triangle_test
`define TESTCFG soc_app_demo_scenario_triangle_test_cfg
...
class `TESTCFG extends soc_app_demo_scenario_base_test_cfg;
  ...
  function new (string name = "soc_app_demo_scenario_triangle_test_cfg");
    super.new(name);
  ...
  //preload_sel
  constraint c_preload_sel     { preload_sel inside {2};} // 2: triangle preloaded

  //waveform_sel
  constraint c_waveform_sel    { waveform_sel == 0;} // waveform_sel should be 0 to get continous triangle
...
class `TESTNAME extends soc_app_demo_scenario_base_test;
  ...
  virtual task main_phase(nnc_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_app_demo_scenario_triangle_test start", NNC_LOW)
    super.main_phase(phase);
    `nnc_info("SOC_TEST", "soc_app_demo_scenario_triangle_test end now", NNC_LOW)
