...
`ifndef FPGA
  ...
  `ifdef BEHAVIORAL
    ...
    if (top_test_cfg.atm !== (30'b10_0000_0000_0000_0000_0000_0000_0000 >> `SOC_TOP.IOBUF_PAD[14:10]))
      begin
        `nnc_error("ATM12", $sformatf("ATM[0:29] = %b is not as expectation of ATM = %b", top_test_cfg.atm, (30'b10_0000_0000_0000_0000_0000_0000_0000 >> `SOC_TOP.IOBUF_PAD[14:10])))
      end  
  `endif
...
`else
        if (`ANA_WRAPPER_TOP.pinmux_if_D2A_TRIM_SIG[103:96]!== {rand_num[7:0]}) begin
        `nnc_error("ATM12", $sformatf("`SOC_TOP.pinmux_if_D2A_TRIM_SIG[103:96] = %b is not as expectation of = %b", `ANA_WRAPPER_TOP.pinmux_if_D2A_TRIM_SIG[103:96], {rand_num[7:0]}));
        end
`endif
