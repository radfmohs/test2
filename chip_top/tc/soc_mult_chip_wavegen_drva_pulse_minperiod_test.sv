...
//--------------------------------------------------------------------------------------
// File Name	: soc_mult_chip_wavegen_drva_pulse_minperiod_test.sv                                                   
// Project	: Nanochap ENS2                                  		        
// Description	: Testcase soc_mult_chip_wavegen_drva_pulse_minperiod_test                                             
...
//***********************************************************************************************
// NOTE : This test is extended from soc_wavegen_drva_pulse_minperiod_test. 
...
// -------------------------------------------------
`define TESTNAME_BASE soc_wavegen_drva_pulse_minperiod_test
`define TESTCFG_BASE soc_wavegen_drva_pulse_minperiod_test_cfg
`define TESTNAME soc_mult_chip_wavegen_drva_pulse_minperiod_test
`define TESTCFG soc_mult_chip_wavegen_drva_pulse_minperiod_test_cfg
...
class `TESTCFG extends `TESTCFG_BASE;
  ...
  function new (string name = "soc_mult_chip_wavegen_drva_pulse_minperiod_test_cfg");
    super.new(name);
