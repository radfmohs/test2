...
`else
        if (`ANA_WRAPPER_TOP.pinmux_if_D2A_ADJ_IO[95:88]!== {6'h0, rand_num[1:0]}) begin
        `nnc_error("ATM26", $sformatf("`SOC_TOP.pinmux_if_D2A_ADJ_IO[95:88] = %b is not as expectation of = %b", `ANA_WRAPPER_TOP.pinmux_if_D2A_ADJ_IO[95:88], {6'h0, rand_num[1:0]}));
        end
`endif
