...
`endif
       if ({ `ANA_TOP.D2A_SDMVCMBUFF_IADJ[1:0]}!== {rand_num[1:0]}) begin
        `nnc_error("ATM26", $sformatf("{` ANA_TOP.D2A_SDMVCMBUFF_IADJ[1:0]} = %b is not as expectation of = %b", { `ANA_TOP.D2A_SDMVCMBUFF_IADJ[1:0]}, {rand_num[1:0]}));
        end
