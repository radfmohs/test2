...
class `TESTCFG extends soc_nirs_ppg_base_test_cfg;
  ...
  //
  //constraint c_nirs_ppg_mode_sel { nirs_ppg_mode_sel inside {2, 6};} //received master single
  ...
  //NIRS_CTRL_7
  //constraint c_threshold_h_10_3               {threshold_h_10_3  inside {[4:4]};} //[7:7]
  //NIRS_CTRL_8
  //constraint c_threshold_h_2_0                {threshold_h_2_0  inside {[0:0]};} //[31:31] //128
  //NIRS_CTRL_5
  //
  //constraint c_threshold_l_18_16              {threshold_l_18_16 inside {[0:0/*0:7*/]};}
  //NIRS_CTRL_9
  //constraint c_threshold_l_15_18              {threshold_l_15_18 inside {[0:0/*0:255*/]};}
  //NIRS_CTRL_10
  //constraint c_threshold_l_7_3                {threshold_l_7_3 inside {[128:128/*0:255*/]};}  //testing purpose 0x80==128 (>DOUT_AC)
  //
...
/*     //At OFFSET 0XC6[5:0], 0XC6[7:0], 0XC7[[7:3]: High Threshold for the IDAC auto cancellation
       ...
       //0XC8[[7:3] == [4:0] High Threshold for the IDAC auto cancellation
       ...
       //Case 1:
       //1)MCU sets MODE_SEL to 4'b0010(RECEIVER MASTER CONT MODE FAST)
...
//       //At OFSET 0xC1(SOC_NIRS_CTRL_0_REG),//steps 1,2,3
