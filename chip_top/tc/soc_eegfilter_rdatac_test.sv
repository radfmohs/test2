...
//--------------------------------------------------------------------------------------
// File Name	: soc_eegfilter_rdatac_test.sv                                                   
// Project	: Nanochap ENS2                                  		        
// Description	: Testcase soc_eegfilter_rdatac_test                                             
// Designer	: shreeyal@nanochap.com                                                                 
// Date		: 05-09-2025                                                                     
// Revision	: 0.1 Initial version created by script                                 
--------------------------------------------------------------------------------------*/
`define TESTNAME soc_eegfilter_rdatac_test
`define TESTCFG soc_eegfilter_rdatac_test_cfg
...
class `TESTCFG extends soc_eegfilter_base_test_cfg;
  ...
  function new (string name = "soc_eegfilter_rdatac_test_cfg");
    super.new(name);
  endfunction: new
...
class `TESTNAME extends soc_eegfilter_base_test;
  ...
  virtual task main_phase(uvm_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_eegfilter_rdatac_test start", UVM_LOW)
     imeas_config();
    ...
    `nnc_info("SOC_TEST", "soc_eegfilter_rdatac_test end now", UVM_LOW)
    // ----------------------------------------------------------------------------------
    // End of adding test 
    // ----------------------------------------------------------------------------------
