...
//--------------------------------------------------------------------------------------
// File Name	: soc_app_demo_scenario_DC_test.sv                                                   
// Project	: Nanochap ENS3                                  		        
// Description	: Testcase soc_app_demo_scenario_DC_test                                             
...
//************************************************************************************
// NOTE : This test checks the leadoff and after that short for DCwave 
//************************************************************************************

// =================================================
// Testcase name is defined
// -------------------------------------------------
`define TESTNAME soc_app_demo_scenario_DC_test
`define TESTCFG soc_app_demo_scenario_DC_test_cfg
...
class `TESTCFG extends soc_app_demo_scenario_base_test_cfg;
  ...
  function new (string name = "soc_app_demo_scenario_DC_test_cfg");
    super.new(name);
  ...
  //preload_sel
  constraint c_preload_sel     { preload_sel inside {1};} // 3: DC preloaded

  //waveform_sel
  constraint c_waveform_sel    { waveform_sel == 0;} // waveform_sel should be 0 to get continous DC
  ...
  constraint c_neg_ena { neg_ena == pos_dis; } // negative enable
  constraint c_leadoff_pos_neg_sel_CHx {leadoff_pos_neg_sel_CH1 == neg_ena;
                                          leadoff_pos_neg_sel_CH2 == neg_ena;
                                          }
  constraint c_stimu_COMP_sel_CHx {stimu_COMP_sel_CH1 == neg_ena; 
                                   stimu_COMP_sel_CH2 == neg_ena;}
...
class `TESTNAME extends soc_app_demo_scenario_base_test;
  ...
  virtual task main_phase(nnc_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_app_demo_scenario_DC_test start", NNC_LOW)
    super.main_phase(phase);
    `nnc_info("SOC_TEST", "soc_app_demo_scenario_DC_test end now", NNC_LOW)
