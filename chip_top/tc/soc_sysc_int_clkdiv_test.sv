...
//--------------------------------------------------------------------------------------
// File Name	: soc_sysc_int_clkdiv_test.sv                                                   
// Project	: Nanochap ENS2                                  		        
// Description	: Testcase soc_sysc_int_clkdiv_test                                             
...
// -------------------------------------------------
`define TESTNAME soc_sysc_int_clkdiv_test
`define TESTCFG soc_sysc_int_clkdiv_test_cfg

class `TESTCFG extends soc_sysc_clkdiv_test_cfg;
  ...
  function new (string name = "soc_sysc_int_clkdiv_test_cfg");
    super.new(name);
...
// -----------------------------------------------
class `TESTNAME extends soc_sysc_clkdiv_test;
  ...
  virtual task main_phase(nnc_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_sysc_int_clkdiv_test start", NNC_LOW)
    ...
    // --------------------------------------------------------
    #10000ns;
    `nnc_info("SOC_TEST", "soc_sysc_int_clkdiv_test end now", NNC_LOW)
