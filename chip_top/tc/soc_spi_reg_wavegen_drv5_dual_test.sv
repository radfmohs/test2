...
//--------------------------------------------------------------------------------------
// File Name	: soc_spi_reg_wavegen_drv5_dual_test.sv                                                   
// Project	: Nanochap ENS2                                  		        
// Description	: Testcase soc_spi_reg_wavegen_drv5_dual_test                                             
...
// -------------------------------------------------
`define TESTNAME soc_spi_reg_wavegen_drv5_dual_test
`define TESTCFG soc_spi_reg_wavegen_drv5_dual_test_cfg

class `TESTCFG extends soc_spi_reg_wavegen_drv5_test_cfg;
  ...
  function new (string name = "soc_spi_reg_wavegen_drv5_dual_test_cfg");
    super.new(name);
...
// -----------------------------------------------
class `TESTNAME extends soc_spi_reg_wavegen_drv5_test;
  ...
  virtual task main_phase(nnc_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_spi_reg_wavegen_drv5_dual_test start", NNC_LOW)
    ...
    // --------------------------------------------------------
    #10000ns;
    `nnc_info("SOC_TEST", "soc_spi_reg_wavegen_drv5_dual_test end now", NNC_LOW)
