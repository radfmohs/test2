...
//--------------------------------------------------------------------------------------
// File Name	: soc_mult_chip_wavegen_drva_pulse_test.sv                                                   
// Project	: Nanochap ENS2                                  		        
// Description	: Testcase soc_mult_chip_wavegen_drva_pulse_test                                             
...
`define TESTNAME soc_mult_chip_wavegen_drva_pulse_test
`define TESTCFG soc_mult_chip_wavegen_drva_pulse_test_cfg
...
class `TESTCFG extends `TESTCFG_BASE;
  ...
  function new (string name = "soc_mult_chip_wavegen_drva_pulse_test_cfg");
    super.new(name);
