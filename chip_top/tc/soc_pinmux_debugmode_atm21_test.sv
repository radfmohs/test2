...
`else
        if (`ANA_WRAPPER_TOP.pinmux_if_D2A_ADJ_IO[55:48] !== 8'h0) begin
        `nnc_error("ATM21", $sformatf("`SOC_TOP.pinmux_if_D2A_ADJ_IO[55:48] = %b is not as expectation of = %b", `ANA_WRAPPER_TOP.pinmux_if_D2A_ADJ_IO[55:48], 8'h0));
        end
`endif
