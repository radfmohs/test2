...
//--------------------------------------------------------------------------------------
// File Name	: soc_wavegen_drva_sine_singlewave_test.sv                                                   
// Project	: Nanochap ENS2                                  		        
// Description	: Testcase soc_wavegen_drva_sine_singlewave_test                                             
...
//***************************************************************************************
// NOTE : The test is intented  to generate sine wave for driver1 & driver2. But 
...
// -------------------------------------------------
`define TESTNAME soc_wavegen_drva_sine_singlewave_test
`define TESTCFG soc_wavegen_drva_sine_singlewave_test_cfg
...
class `TESTCFG extends soc_wavegen_base_test_cfg;
  ...
  function new (string name = "soc_wavegen_drva_sine_singlewave_test_cfg");
    super.new(name);
...
class `TESTNAME extends soc_wavegen_base_test;
  ...
  virtual task main_phase(nnc_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_wavegen_drva_sine_singlewave_test start", NNC_LOW)
    ...
    // --------------------------------------------------------
    #200ms;
    `nnc_info("SOC_TEST", "soc_wavegen_drva_sine_singlewave_test end now", NNC_LOW)
