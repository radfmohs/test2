...
//--------------------------------------------------------------------------------------
// File Name	: soc_mult_chip_wavegen_drva_sine_diff_config_test.sv                                                   
// Project	: Nanochap ENS2                                  		        
// Description	: Testcase soc_mult_chip_wavegen_drva_sine_diff_config_test                                             
...
//***************************************************************************************
// NOTE : This test is extended from soc_wavegen_drva_sine_test. 
//        The test is intented to generate sine wave for driver1 & driver2 in multiple
...
// -------------------------------------------------
`define TESTNAME_BASE soc_wavegen_drva_sine_test
`define TESTCFG_BASE soc_wavegen_drva_sine_test_cfg
`define TESTNAME soc_mult_chip_wavegen_drva_sine_diff_config_test
`define TESTCFG soc_mult_chip_wavegen_drva_sine_diff_config_test_cfg
...
class `TESTCFG extends `TESTCFG_BASE;
  ...
  function new (string name = "soc_mult_chip_wavegen_drva_sine_diff_config_test_cfg");
    super.new(name);
...
class `TESTNAME extends `TESTNAME_BASE;
  ...
  virtual task main_phase(nnc_phase phase);
    ...
    `nnc_info("SOC_TEST", "soc_mult_chip_wavegen_drva_sine_diff_config_test start", NNC_LOW)
    ...
    `nnc_info("SOC_TEST", "soc_mult_chip_wavegen_drva_sine_diff_config_test end now", NNC_LOW)
