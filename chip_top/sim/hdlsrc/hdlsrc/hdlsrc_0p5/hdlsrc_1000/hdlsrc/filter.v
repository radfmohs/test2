...
// Generated on: 2025-09-24 13:32:59
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
  ...
  // Type Definitions
  // Constants
  parameter signed [15:0] scaleconst1 = 16'b0111110110010000; //sfix16_En17
  ...
  parameter signed [15:0] coeff_a2_section1 = 16'b0010000010011100; //sfix16_En14
  parameter signed [15:0] coeff_a3_section1 = 16'b0000000000000000; //sfix16_En14
  // Signals
  reg  signed [31:0] input_register; // sfix32
  wire signed [74:0] scale1; // sfix75_En44
  wire signed [47:0] mulcsd_temp; // sfix48_En17
  wire signed [31:0] scaletypeconvert1; // sfix32_En28
  //   -- Section 1 Signals 
  ...
  wire signed [29:0] mulcsd_temp_1; // sfix30_En29
  ...
  assign mulcsd_temp = 
        $signed({input_register, 15'b000000000000000}) -
  ...
  assign scale1 = $signed({mulcsd_temp[47:0], 27'b000000000000000000000000000});
  ...
  assign inputconv1 = $signed({scaletypeconvert1[31:0], 1'b0});

  assign mulcsd_temp_1 = 
        $signed({delay_section1, 13'b0000000000000}) +
        $signed({delay_section1, 7'b0000000}) +
        $signed({delay_section1, 5'b00000}) -
        $signed({delay_section1, 2'b00});
  assign a2mul1 = $signed({{2{mulcsd_temp_1[29]}}, mulcsd_temp_1});
