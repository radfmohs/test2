//==============================================================================
// Test Bench for adc_cap_ctrl module - With Signal Monitoring
//==============================================================================
...
always @(posedge sysclk) begin
    $display("[%0t] A2D_ADC_DATA_EN=%b, final_active=%b, A2D_ADC_DATA_VLD=%b, D2A_STIM_PAD0=%d",
        $time, A2D_ADC_DATA_EN, dut.final_active_stim, A2D_ADC_DATA_VLD, D2A_STIM_PAD0);
end
...
initial begin
    $display("===============================================");
    $display("ADC CAP CTRL Testbench - Monitoring");
    $display("===============================================\n");
    ...
    //==========================================================================
    // Test: Simple ADC Data Capture
    //==========================================================================
    $display("\n--- Test: Simple ADC Data Capture ---");
    $display("Setting o_source_driver = 0x0001 (enable driver)");
    o_source_driver = 16'h0001;
    #20;
    
    $display("Asserting A2D_ADC_DATA_EN with data = 512");
    ...
    $display("Setting A2D_ADC_DATA = 520 for second sample");
